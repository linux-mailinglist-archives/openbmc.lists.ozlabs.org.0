Return-Path: <openbmc+bounces-1413-lists+openbmc=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+openbmc@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qKlfA/K+nmnsXAQAu9opvQ
	(envelope-from <openbmc+bounces-1413-lists+openbmc=lfdr.de@lists.ozlabs.org>)
	for <lists+openbmc@lfdr.de>; Wed, 25 Feb 2026 10:20:50 +0100
X-Original-To: lists+openbmc@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 678D3194CF6
	for <lists+openbmc@lfdr.de>; Wed, 25 Feb 2026 10:20:49 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4fLTZX0WSnz3dXS;
	Wed, 25 Feb 2026 20:20:04 +1100 (AEDT)
X-Original-To: openbmc@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=211.20.114.72
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1772011204;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1772011204; c=relaxed/relaxed;
	bh=jKMvm1A9CyM1xREcnx1BUtZtEyQLd5mb32GI59ocoVM=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-ID:References:
	 In-Reply-To:To:CC; b=
...
Received: from TWMBX01.aspeed.com (mail.aspeedtech.com [211.20.114.72])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4fLTZV4WN4z3dXK;
...
Date: Wed, 25 Feb 2026 17:19:40 +0800
Subject: [PATCH v25 3/4] i2c: ast2600: Add controller driver for AST2600
 new register set
...
Message-ID: <20260225-upstream_i2c-v25-3-9f4bdd954f3f@aspeedtech.com>
...
X-Mailer: b4 0.14.3
X-Developer-Signature: v=1; a=ed25519-sha256; t=1772011180; l=36641;
 i=ryan_chen@aspeedtech.com; s=20251126; h=from:subject:message-id;
 bh=qty/AEYmXJtCF7x8JbBGFh7RTNsaqdpSuAK/XpP7qjs=;
 b=DJWA1mhqRpr+YBeQ5Pkzirh4ZexI50jKVYfynjpsG2C82U1pHejFC/WkJtuO9oD8tM9boZBFw
 6QKLWcCS0LCAoAkol4Nh3UDM3byAaSmG7Ku8uF/PfxExY1aCHOcjpu8
...
X-Spamd-Result: default: False [1.50 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-1413-lists,openbmc=lfdr.de];
	NEURAL_HAM(-0.00)[-0.983];
	RCVD_TLS_LAST(0.00)[];
	R_DKIM_NA(0.00)[];
	FORGED_RECIPIENTS_MAILLIST(0.00)[]
X-Rspamd-Queue-Id: 678D3194CF6
