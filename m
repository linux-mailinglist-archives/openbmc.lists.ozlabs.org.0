...
ting this and I wasn&#39;t, but I&#39;ll take a look.=C2=A0</div></div></di=
v></blockquote><div><br></div><div>Verified I can reproduce:</div><div>chec=
king that generated files are newer than configure... done<br>configure: er=
ror: conditional &quot;HAVE_SYSTEMD&quot; was never defined.<br>Usually thi=
s means the macro was only invoked conditionally.<br>root@3b8289721be4:/pho=
