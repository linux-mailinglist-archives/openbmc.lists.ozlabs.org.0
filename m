...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id D933B790038
	for <lists+openbmc@lfdr.de>; Fri,  1 Sep 2023 17:58:37 +0200 (CEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=google.com header.i=@google.com header.a=rsa-sha256 header.s=20221208 header.b=dJnAIsjt;
	dkim-atps=neutral
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4RcjPQ1tQhz3c4t
	for <lists+openbmc@lfdr.de>; Sat,  2 Sep 2023 01:58:34 +1000 (AEST)
X-Original-To: openbmc@lists.ozlabs.org
Delivered-To: openbmc@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=google.com header.i=@google.com header.a=rsa-sha256 header.s=20221208 header.b=dJnAIsjt;
	dkim-atps=neutral
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized) smtp.mailfrom=google.com (client-ip=2a00:1450:4864:20::436; helo=mail-wr1-x436.google.com; envelope-from=edtanous@google.com; receiver=lists.ozlabs.org)
Received: from mail-wr1-x436.google.com (mail-wr1-x436.google.com [IPv6:2a00:1450:4864:20::436])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4RcjNl6YFJz3bxL
	for <openbmc@lists.ozlabs.org>; Sat,  2 Sep 2023 01:57:58 +1000 (AEST)
Received: by mail-wr1-x436.google.com with SMTP id ffacd0b85a97d-31977ace1c8so1853279f8f.1
        for <openbmc@lists.ozlabs.org>; Fri, 01 Sep 2023 08:57:58 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20221208; t=1693583876; x=1694188676; darn=lists.ozlabs.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=z61DAl9KQkTkxbrzCUz4B+FlpEDfJSOuluWNZVYZm00=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1693583876; x=1694188676;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=z61DAl9KQkTkxbrzCUz4B+FlpEDfJSOuluWNZVYZm00=;
        b=
X-Gm-Message-State: AOJu0Ywk34xR80iLniXHE8a4syekkCwND0suWi/Z9XdcFoyPijnXEzE0
	yQzTsL7xqpe8zNol5hq4MkpPgKXy7a6cG6pAuAVSEw==
X-Google-Smtp-Source: AGHT+IEspUSOyUnAMUHB0SfwtU9ojctNwIyUY1CMicRC70WXjHQTAJS/YFjCNpHKPy1S/i3HuDCvkXUDjzaNIY2NEaE=
X-Received: by 2002:a5d:46cb:0:b0:31a:e06f:2187 with SMTP id
 g11-20020a5d46cb000000b0031ae06f2187mr2126348wrs.56.1693583875299; Fri, 01
 Sep 2023 08:57:55 -0700 (PDT)
MIME-Version: 1.0
References: <CAPY-kLVD7ONa6fkSrQ5sfAxK4UcGZSyHoMr6sb6oQPTafMT_fw@mail.gmail.com>
 ...
 <CAH2-KxDi4pvQ+Y6WJ6_LPRvjQgrxH=tKhe59ODGSeKgU=eVwrA@mail.gmail.com> <CAPY-kLX2Vhyva_p6bKe7LGG-2fo0QB=AeeDnipcMAPz18+=Amg@mail.gmail.com>
In-Reply-To: <CAPY-kLX2Vhyva_p6bKe7LGG-2fo0QB=AeeDnipcMAPz18+=Amg@mail.gmail.com>
From: Ed Tanous <edtanous@google.com>
Date: Fri, 1 Sep 2023 08:57:42 -0700
Message-ID: <CAH2-KxCt+hWRBrWJXgJnO1+pUe1io6H3oksQKd9kwZy9ZMtM0Q@mail.gmail.com>
Subject: Re: Error handling
To: chandu chanti <chandutmba@gmail.com>
Content-Type: multipart/related; boundary="00000000000049a83c06044e39d8"
...
--00000000000049a83c06044e39d8
Content-Type: multipart/alternative; boundary="00000000000049a83b06044e39d7"

--00000000000049a83b06044e39d7
Content-Type: text/plain; charset="UTF-8"
Content-Transfer-Encoding: quoted-printable

On Fri, Sep 1, 2023 at 7:21=E2=80=AFAM chandu chanti <chandutmba@gmail.com>=
 wrote:
...
> https://www.dmtf.org/sites/default/files/standards/documents/DSP0266_1.18=
.0.pdf
...
> case?  Can you point to a place where an error is returned that you'd lik=
e
> >handled differently?
...
> >
> https://github.com/openbmc/bmcweb/blob/99bf026224d6ea60be27bd36793ddfaea5=
537d2a/redfish-core/lib/sensors.hpp#L934
>
...
>> policies are written down in DBUS_USAGE.md.   Please familiarize yoursel=
f
...
>>
>> If the dbus data type is incorrect this already sets internal error
>> (500).  Please look at sdbusplus::unpackPropertiesNoThrow usage in bmcwe=
b.
>> Given that the interface failed, this is the most specific error we can
>> give the user.  We do log the source of the error though.
>>
...
>>> value matches the error value, we will update the property value as nul=
l in
...
>>> null value will be allocated to the JSON response. Example for the uint=
16_t
>>> data type.
>>>
>>
...
>> failing property can fail the whole call is correct, that's the intent. =
 If
>> an internal service fails, that needs propagated to the user, in the for=
m
...
>>>> >> I didn't see anyone else answer this.  Is your question about how t=
o
...
>>>> error. But this did not work well with current bmcweb implementation(g=
et
...
>>>> properties on dbus.
>>>> 3. Use "default values" per property data type, but this would fail fo=
r
>>>> extreme cases like if the property is u32, and if the default value us=
ed
>>>> was INT_MAX, then it breaks when the property could take value 0xFFFFF=
FFF
>>>> as valid value.
...
>>>> Shakeeb
>>>>
>>>> On Thu, Aug 3, 2023 at 10:33=E2=80=AFPM Joseph Reynolds <jrey@linux.ib=
m.com>
>>>> wrote:
>>>>
...
>>>>> > Report Suspicious
>>>>> > <
>>>>> https://us-phishalarm-ewt.proofpoint.com/EWT/v1/PjiDSg!12-vrJJyaRL1Nu=
s7N26ProiLa90y_FB6oawxkmvrT4YcN373bBkdTP-XPRTFLRBygswzt1TwX0wxp5Tel83pR4ZZR=
...
>>>>> We
>>>>> > are considering the following approaches to implement it, but we ar=
e
...
>>>>> assume so.
>>>>>
>>>>> I don't have any special insights.  Are you looking to follow a desig=
n
>>>>> pattern?  Are you looking for direction from the BMCWeb maintainers?
>>>>>
>>>>> Joseph
>>>>>
>>>>> > 1 . Using exceptions in our backend D-Bus service by throwing
>>>>> > exceptions in the D-Bus property get handlers. It works fine for th=
e
...
>>>>> other
>>>>> > properties. Is there a way to implement exceptions in GetAll so tha=
t
...
<div dir=3D"ltr" class=3D"gmail_attr">On Fri, Sep 1, 2023 at 7:21=E2=80=AFA=
M chandu chanti &lt;<a href=3D"mailto:chandutmba@gmail.com">chandutmba@gmai=
l.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=3D"ma=
rgin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:=
1ex"><div dir=3D"ltr"><br>&gt;Overall, I&#39;ve read the code, and your ema=
il, and I really have no idea what&#39;s being proposed that doesn&#39;t al=
ready exist in a much simpler form, <br>&gt;using the existing error handli=
ng mechanisms.=C2=A0 While your point that one failing property can fail th=
e whole call is correct, <br>&gt;that&#39;s the intent.=C2=A0 If an interna=
l service fails, that needs propagated to the user, in the form of an error=
 code, per the Redfish specification.<br><br>please refer Table 17 =E2=80=
=94 Primitive data types in <a href=3D"https://www.dmtf.org/sites/default/f=
iles/standards/documents/DSP0266_1.18.0.pdf" target=3D"_blank">https://www.=
dmtf.org/sites/default/files/standards/documents/DSP0266_1.18.0.pdf</a><br>=
null value, which the service uses when it is unable to determine the prope=
rty&#39;s value due to an error or<br>other temporary condition, or if the =
schema has requirements for using null for other special conditions.<br><br=
><br>&gt; One thing I don&#39;t understand is what code is actually failing=
 in this case?=C2=A0 Can you point to a place where an error is returned th=
at you&#39;d like &gt;handled differently? =C2=A0<br>&gt; Speaking in concr=
ete terms would help to make the generalized change you&#39;re attempting h=
ere<br><br>If there is an error in only one property, we want to represent =
that a specific property is failing in the URI instead of failing the entir=
e URI.<br></div></blockquote><div><br></div><div>Please point to a failing =
branch in code you&#39;d like handled differently.=C2=A0 Again, you&#39;ve =
answered in the abstract which isn&#39;t helping me understand what you&#39=
;re trying to accomplish.</div><div>=C2=A0</div><blockquote class=3D"gmail_=
quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,=
204);padding-left:1ex"><div dir=3D"ltr"><br><br>&gt;Please look at error_me=
ssages.hpp and error_messages.cpp<br><br>We cannot have error messages when=
 the HTTP return code is 200.<br></div></blockquote><div><br></div><div>If =
there is an error, the return code should not be 200.=C2=A0 200 OK is reser=
ved for when there was no error.</div><div>=C2=A0</div><blockquote class=3D=
"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(2=
04,204,204);padding-left:1ex"><div dir=3D"ltr"><br><br>&gt; For properties =
that have a &quot;null&quot; or &quot;invalid&quot; value, this is already =
implemented, generally with a simple branch.<br>&gt; Example from sensors:<=
br>&gt;<a href=3D"https://github.com/openbmc/bmcweb/blob/99bf026224d6ea60be=
27bd36793ddfaea5537d2a/redfish-core/lib/sensors.hpp#L934" target=3D"_blank"=
>https://github.com/openbmc/bmcweb/blob/99bf026224d6ea60be27bd36793ddfaea55=
37d2a/redfish-core/lib/sensors.hpp#L934</a><br><br>This addresses only the =
double datatype.</div></blockquote><div><br></div><div>This is an example f=
or a double data type.=C2=A0 The other types can be done in similar manners=
, if the dbus interface allows it.</div><div>=C2=A0</div><blockquote class=
=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rg=
b(204,204,204);padding-left:1ex"><div dir=3D"ltr"> We are planning to imple=
ment it for all data types. Please refer to the following table.<br><br>&gt=
;If the dbus data type is incorrect this already sets internal error (500).=
 =C2=A0<br>&gt;Please look at sdbusplus::unpackPropertiesNoThrow usage in b=
mcweb. =C2=A0<br>&gt;Given that the interface failed, this is the most spec=
ific error we can give the user.=C2=A0 We do log the source of the error th=
ough.<br><br>We are considering the case where only one property is failing=
, not the entire interface. We don&#39;t want to fail the entire URI <br>an=
d we had mentioned the same in the very first email.<br></div></blockquote>=
<div><br></div><div>Sorry, but this sounds like you plan on not propagating=
 errors to the user.=C2=A0 I can&#39;t think of a case where that would be =
the correct thing to do.=C2=A0 If the internal service failed, bmcweb shoul=
d report that to the user through a return code and error property.</div><d=
iv>=C2=A0</div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0p=
x 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=
=3D"ltr"><br>&gt;&gt; 1 . Using exceptions in our backend D-Bus service by =
throwing exceptions in the D-Bus property get handlers. <br>&gt;&gt;It work=
s fine for the Get property method call. However, when using the Get All me=
thod call, <br>&gt;&gt;if one property fails, an error is returned without =
checking the other properties. <br>&gt;&gt;Is there a way to implement exce=
ptions in GetAll so that even if one property fails, we can still fetch the=
 remaining properties.<br><br><br>Error represenation Table for different d=
ata types<br>| D-Bus Data Type | Value of the D-Bus Property in case of Err=
or | Property Value as seen on Redfish |<br>|-----------------|------------=
---------------------------------|----------------------------------|<br>| =
INT16 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 | INT_MAX =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 | null =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 |<br>| UINT16 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0| UINT_MAX =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0| null =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 |<br>| INT32 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0 | LONG_MAX =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0| null =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 |<br>| UINT32 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0| ULONG_MAX =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 | null =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 |<br>| INT64 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 | LLONG_MAX =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 | nul=
l =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 |<br>| UINT64 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0| =
ULLONG_MAX =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0| null =C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 |<br>| DOUBLE =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0| std::numeric_l=
imits&lt;T&gt;::quiet_NaN() =C2=A0 =C2=A0 =C2=A0 =C2=A0| null =C2=A0 =C2=A0=
 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 |<br>| STRING =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0| BE_ERROR-XXX =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0| null =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 |<br>=
| BOOL =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0| uint8_t {0=E2=80=93false,=
 1=E2=80=93true, others- error} =C2=A0 =C2=A0| null =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 |<br></div><br><div class=3D"gmail_quote"><div dir=3D"ltr" class=3D"gma=
il_attr">On Thu, Aug 31, 2023 at 10:31=E2=80=AFPM Ed Tanous &lt;<a href=3D"=
mailto:edtanous@google.com" target=3D"_blank">edtanous@google.com</a>&gt; w=
rote:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0p=
x 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=
=3D"ltr"><div dir=3D"ltr"><br></div><br><div class=3D"gmail_quote"><div dir=
=3D"ltr" class=3D"gmail_attr">On Thu, Aug 31, 2023 at 4:47=E2=80=AFAM chand=
u chanti &lt;<a href=3D"mailto:chandutmba@gmail.com" target=3D"_blank">chan=
dutmba@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" =
style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);pa=
dding-left:1ex"><div dir=3D"ltr">Hi team,<br><br>We have drafted a proposal=
 for=C2=A0 &quot;<span style=3D"font-family:Calibri,sans-serif;font-size:14=
.6667px">Using default values in D-Bus properties to indicate errors&quot;=
=C2=A0</span>=C2=A0as=C2=A0<span dir=3D"ltr">communicated in previous mail.=
</span><br><br>Issue with Existing Implementation:<br>Error handling is not=
 implemented in the existing bmcweb source.</div></blockquote><div><br></di=
v><div>This statement is verifiably incorrect.=C2=A0 Many discussions have =
been had about how we handle Dbus, json, and Redfish errors, and the handli=
ng policies are written down in DBUS_USAGE.md.=C2=A0 =C2=A0Please familiari=
ze yourself with those previous discussions, and if you believe=C2=A0the co=
nclusion was incorrect, quote those in your response.</div><div>=C2=A0</div=
><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border=
-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"> The va=
lues fetched from D-Bus are used directly in the Redfish response, except f=
or some properties.</div></blockquote><div><br></div><div>While this is tru=
e for properties that are intended to be sent directly to the user, like As=
set information, it&#39;s not true of all properties.</div><div>=C2=A0</div=
><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border=
-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"> T<span=
 dir=3D"ltr">here was no way to represent error for a given data type on Re=
dfish.</span></div></blockquote><div><br></div><div>Please look at error_me=
ssages.hpp and error_messages.cpp</div><div>=C2=A0</div><blockquote class=
=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rg=
b(204,204,204);padding-left:1ex"><div dir=3D"ltr"><br><br>New Implementatio=
n Proposal:<br>We plan to handle errors from backend D-Bus services in bmcw=
eb using a custom data type class. We will implement a helper class to crea=
te a new data type called mydatatype_t. An object of this class will be cre=
ated with the D-Bus property value as input. This object will be assigned t=
o the JSON response using the assignment operator. This assignment operatio=
n will invoke the to_json function with the mydatatype_t object, where D-Bu=
s values will be validated based on their data types.=C2=A0</div></blockquo=
te><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;bord=
er-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=3D"ltr"><br>D=
ata Types and Default Values:<br>The following values will be set on the D-=
Bus property in case of an error, based on the data type.</div></blockquote=
><div><br></div><div>If the dbus data type is incorrect this already sets i=
nternal error (500).=C2=A0 Please look at=C2=A0sdbusplus::unpackPropertiesN=
oThrow usage in bmcweb.=C2=A0 Given that the interface failed, this is the =
most specific error we can give the user.=C2=A0 We do log the source of the=
 error though.</div><div>=C2=A0</div><blockquote class=3D"gmail_quote" styl=
e=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);paddin=
g-left:1ex"><div dir=3D"ltr"> In Redfish, we will validate these properties=
. If the D-Bus property value matches the error value, we will update the p=
roperty value as null in the Redfish JSON response; otherwise, the correspo=
nding value on D-Bus will be used.<br></div></blockquote><div><br></div><di=
v>For properties that have a &quot;null&quot; or &quot;invalid&quot; value,=
 this is already implemented, generally with a simple branch.</div><div>Exa=
mple from sensors:<br><a href=3D"https://github.com/openbmc/bmcweb/blob/99b=
f026224d6ea60be27bd36793ddfaea5537d2a/redfish-core/lib/sensors.hpp#L934" ta=
rget=3D"_blank">https://github.com/openbmc/bmcweb/blob/99bf026224d6ea60be27=
bd36793ddfaea5537d2a/redfish-core/lib/sensors.hpp#L934</a><br></div><div><b=
r></div><div><br></div><div>=C2=A0</div><blockquote class=3D"gmail_quote" s=
tyle=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);pad=
ding-left:1ex"><div dir=3D"ltr"><br><table border=3D"0" cellspacing=3D"0" c=
ellpadding=3D"0" style=3D"border-collapse:collapse">
 <thead>
  <tr>
