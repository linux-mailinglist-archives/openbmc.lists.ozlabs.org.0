...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 981E25294D6
	for <lists+openbmc@lfdr.de>; Tue, 17 May 2022 01:15:12 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4L2FTV3pJ4z3byS
	for <lists+openbmc@lfdr.de>; Tue, 17 May 2022 09:15:10 +1000 (AEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20210112 header.b=YAgaXrpA;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org; dkim=pass (2048-bit key;
 ...
 header.s=20210112 header.b=YAgaXrpA; dkim-atps=neutral
Received: from mail-pf1-x429.google.com (mail-pf1-x429.google.com
 [IPv6:2607:f8b0:4864:20::429])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
 (No client certificate requested)
 by lists.ozlabs.org (Postfix) with ESMTPS id 4KzNfF1GbQz3bZP
 for <openbmc@lists.ozlabs.org>; Thu, 12 May 2022 17:27:49 +1000 (AEST)
Received: by mail-pf1-x429.google.com with SMTP id a11so4057926pff.1
 for <openbmc@lists.ozlabs.org>; Thu, 12 May 2022 00:27:49 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=from:to:cc:subject:date:message-id:in-reply-to:references;
 bh=LA5SCQGnMONYpZdP51AOih1x6PseA+ot7xdzRboe7Rs=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :references;
 bh=LA5SCQGnMONYpZdP51AOih1x6PseA+ot7xdzRboe7Rs=;
 b=
X-Gm-Message-State: AOAM532BPRd1/rELhywVyDMU/BERo4OxKX4gU7dtFCWQO2DZasoXktgH
 ayeSRCaM2lN7HUMS5bJ1rJs=
X-Google-Smtp-Source: ABdhPJxzb3QfhzP9Uz9MJHFgECsgEo8ScPzQbrobal2A7dhFxodmcWeu4BpMFApDZc0Rur+Ka+RHoQ==
X-Received: by 2002:a63:535c:0:b0:3db:69da:1ef7 with SMTP id
 t28-20020a63535c000000b003db69da1ef7mr1144089pgl.239.1652340468391; 
 Thu, 12 May 2022 00:27:48 -0700 (PDT)
Received: from localhost.localdomain (60-250-192-107.hinet-ip.hinet.net.
 [60.250.192.107]) by smtp.gmail.com with ESMTPSA id
 z9-20020aa79e49000000b0050dc762813csm3082779pfq.22.2022.05.12.00.27.45
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 12 May 2022 00:27:47 -0700 (PDT)
From: Marvin Lin <milkfafa@gmail.com>
X-Google-Original-From: Marvin Lin <kflin@nuvoton.com>
To: mchehab@kernel.org, linux-media@vger.kernel.org,
 linux-kernel@vger.kernel.org
Subject: [PATCH v1 5/5] drivers: media: platform: Add NPCM Video
 Capture/Encode Engine driver
Date: Thu, 12 May 2022 15:27:22 +0800
Message-Id: <20220512072722.25005-6-kflin@nuvoton.com>
...
index edc96cdb85e8..ea4608aa05dc 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -2433,6 +2433,7 @@ F:	arch/arm/boot/dts/nuvoton-npcm*
...
index 000000000000..8718631b0424
--- /dev/null
...
new file mode 100644
index 000000000000..63041bb526a9
--- /dev/null
+++ b/drivers/media/platform/nuvoton/Makefile
@@ -0,0 +1,2 @@
+# SPDX-License-Identifier: GPL-2.0-only
+obj-$(CONFIG_VIDEO_NUVOTON) += npcm-video.o
diff --git a/drivers/media/platform/nuvoton/npcm-video.c b/drivers/media/platform/nuvoton/npcm-video.c
new file mode 100644
index 000000000000..4ed5290f4c5d
--- /dev/null
