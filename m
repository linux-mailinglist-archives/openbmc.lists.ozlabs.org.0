...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A84D98CD92
	for <lists+openbmc@lfdr.de>; Wed,  2 Oct 2024 09:03:36 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4XJQk41xw4z3fSy
	for <lists+openbmc@lfdr.de>; Wed,  2 Oct 2024 17:02:52 +1000 (AEST)
X-Original-To: openbmc@lists.ozlabs.org
Delivered-To: openbmc@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=211.20.114.72
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1727852557;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1727852557; c=relaxed/relaxed;
	bh=ci3gYLKAnjBjxW3kjG2oSoM+qgxxZ/fQlQWwx7l1IbI=;
	h=From:To:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=
...
Received: from TWMBX01.aspeed.com (mail.aspeedtech.com [211.20.114.72])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4XJQjn2Syxz2yF1;
	Wed,  2 Oct 2024 17:02:37 +1000 (AEST)
...
Subject: [PATCH v14 2/3] i2c: aspeed: support AST2600 i2c new register mode driver
Date: Wed, 2 Oct 2024 15:02:12 +0800
Message-ID: <20241002070213.1165263-3-ryan_chen@aspeedtech.com>
...
---
 ...
 drivers/i2c/busses/i2c-ast2600.c | 1031 ++++++++++++++++++++++++++++++
...
index 000000000000..7084f2297a07
--- /dev/null
...
+			case 1:
+				wbuf_dword = msg->buf[i2c_bus->master_xfer_cnt + i];
+				break;
+			case 2:
+				wbuf_dword =
