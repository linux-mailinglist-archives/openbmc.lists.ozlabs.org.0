...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id 98BC6496F4
	for <lists+openbmc@lfdr.de>; Tue, 18 Jun 2019 03:39:25 +0200 (CEST)
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 45SW2y5ZgXzDqVK
	for <lists+openbmc@lfdr.de>; Tue, 18 Jun 2019 11:39:22 +1000 (AEST)
...
Authentication-Results: lists.ozlabs.org; dkim=pass (2048-bit key;
 ...
 header.b="JJ6U820q"; dkim=pass (2048-bit key;
 unprotected) header.d=messagingengine.com header.i=@messagingengine.com
 header.b="kpqxDirG"; dkim-atps=neutral
Received: from out5-smtp.messagingengine.com (out5-smtp.messagingengine.com
 [66.111.4.29])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by lists.ozlabs.org (Postfix) with ESMTPS id 45SW1D6cXGzDqVC
 for <openbmc@lists.ozlabs.org>; Tue, 18 Jun 2019 11:37:52 +1000 (AEST)
Received: from compute2.internal (compute2.nyi.internal [10.202.2.42])
 by mailout.nyi.internal (Postfix) with ESMTP id 8061822091;
 Mon, 17 Jun 2019 21:37:49 -0400 (EDT)
Received: from mailfrontend2 ([10.202.2.163])
 by compute2.internal (MEProxy); Mon, 17 Jun 2019 21:37:49 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
 mendozajonas.com; h=from:to:cc:subject:date:message-id
 :in-reply-to:references:mime-version:content-transfer-encoding;
 s=fm3; bh=J/gsdKkoaZX6a7FPB/VoJCDxLxvu8nFyCKqMJrGgq4w=; b=JJ6U8
 
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
 messagingengine.com; h=cc:content-transfer-encoding:date:from
 :in-reply-to:message-id:mime-version:references:subject:to
 :x-me-proxy:x-me-proxy:x-me-sender:x-me-sender:x-sasl-enc; s=
 fm3; bh=J/gsdKkoaZX6a7FPB/VoJCDxLxvu8nFyCKqMJrGgq4w=; b=kpqxDirG
 
X-ME-Sender: <xms:bUAIXZI6Rb3VyvXBp0PhubuPkO6p0L-AD79M7BMVBckwu5L7QGGr2w>
X-ME-Proxy-Cause: gggruggvucftvghtrhhoucdtuddrgeduuddrudeikedggeeiucetufdoteggodetrfdotf
 ...
 eptd
X-ME-Proxy: <xmx:bUAIXaUetT8d_7Zgr3ns7xHhFndj2e35p7fYsYQqyvtbbZptnyO8JQ>
 <xmx:bUAIXSHViXKXGQO5Yfm6b71cp4zDfJcLXt3TS2BO_at-XfbqYNXLMQ>
 <xmx:bUAIXTe0uRXuTOq9jsQE_OI123rS5sk3iJENcGSZ6L9HPxCIElRZDw>
 <xmx:bUAIXRaTfwvtqQhGZ24XnvvsnEHZm3No02Tujs9lNUTJ8qiBUvl7hA>
Received: from v4.ozlabs.ibm.com (unknown [122.99.82.10])
 by mail.messagingengine.com (Postfix) with ESMTPA id C8D86380085;
 Mon, 17 Jun 2019 21:37:45 -0400 (EDT)
From: Samuel Mendoza-Jonas <sam@mendozajonas.com>
To: u-boot@lists.denx.de
Subject: [PATCH v2 1/4] phy: Add support for the NC-SI protocol
Date: Tue, 18 Jun 2019 11:37:17 +1000
Message-Id: <20190618013720.2823-2-sam@mendozajonas.com>
...
index 44b32385c4..20c448ee60 100644
--- a/include/net.h
+++ b/include/net.h
...
index d01435d1aa..297fc7a78e 100644
--- a/include/phy.h
+++ b/include/phy.h
@@ -17,6 +17,7 @@
