...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F12A992A6
	for <lists+openbmc@lfdr.de>; Thu, 22 Aug 2019 13:54:44 +0200 (CEST)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 46Djcx4mtCzDrDr
	for <lists+openbmc@lfdr.de>; Thu, 22 Aug 2019 21:54:41 +1000 (AEST)
...
X-Greylist: delayed 6600 seconds by postgrey-1.36 at bilbo;
 Thu, 22 Aug 2019 21:40:19 AEST
Received: from 4.mo177.mail-out.ovh.net (4.mo177.mail-out.ovh.net
 [46.105.37.72])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by lists.ozlabs.org (Postfix) with ESMTPS id 46DjJM0s4XzDr0m
 for <openbmc@lists.ozlabs.org>; Thu, 22 Aug 2019 21:40:15 +1000 (AEST)
Received: from player729.ha.ovh.net (unknown [10.109.160.143])
 by mo177.mail-out.ovh.net (Postfix) with ESMTP id 77575102F3C
 for <openbmc@lists.ozlabs.org>; Thu, 22 Aug 2019 11:14:31 +0200 (CEST)
Received: from kaod.org (lfbn-ren-1-123-36.w83-205.abo.wanadoo.fr
 [83.205.208.36]) (Authenticated sender: clg@kaod.org)
 by player729.ha.ovh.net (Postfix) with ESMTPSA id 05B7292E3676;
 Thu, 22 Aug 2019 09:14:25 +0000 (UTC)
Subject: Re: [RFC PATCH qemu] hw: Introduce models for IBM's Flexible Service
 Interface
To: Andrew Jeffery <andrew@aj.id.au>, joel@jms.id.au
References: <20190822055358.26196-1-andrew@aj.id.au>
From: =?UTF-8?Q?C=c3=a9dric_Le_Goater?= <clg@kaod.org>
Message-ID: <3389229c-c5df-5030-0c10-1146f590eaea@kaod.org>
Date: Thu, 22 Aug 2019 11:14:24 +0200
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.8.0
MIME-Version: 1.0
In-Reply-To: <20190822055358.26196-1-andrew@aj.id.au>
Content-Type: text/plain; charset=utf-8
Content-Language: en-US
Content-Transfer-Encoding: 7bit
X-Ovh-Tracer-Id: 6698541499598342914
X-VR-SPAMSTATE: OK
X-VR-SPAMSCORE: -100
X-VR-SPAMCAUSE: gggruggvucftvghtrhhoucdtuddrgeduvddrudeghedgudefucetufdoteggodetrfdotffvucfrrhhofhhilhgvmecuqfggjfdpvefjgfevmfevgfenuceurghilhhouhhtmecuhedttdenucesvcftvggtihhpihgvnhhtshculddquddttddm
...
On 22/08/2019 07:53, Andrew Jeffery wrote:
...
I have merged this patch in aspeed-4.2 to get more exposure.
...
We have a similar model on PowerNV machine (below the LPC one) and
I wonder how we could link them together.  Please look at the P8 
pnv_lpc_do_eccb() and the P9 pnv_lpc_mmio_read/write routines.
...
here is the qom-tree equivalent.

    /fsi[0] (aspeed.apb2opb)
      /opb.0 (opb)
        /fsi-master (fsi.master)
          /fsi.opb2fsi[0] (qemu:memory-region)
          /fsi.bus.0 (fsi.bus)
            /cfam (cfam)
              /cfam.config (cfam.config)
                /cfam.config[0] (qemu:memory-region)
              /lbus.0 (lbus)
                /lbus[0] (qemu:memory-region)
              /fsi.slave[0] (qemu:memory-region)
              /cfam[0] (qemu:memory-region)
          /fsi.master[0] (qemu:memory-region)
      /aspeed.apb2opb[0] (qemu:memory-region)
      /opb.1 (opb)
        /fsi-master (fsi.master)
          /fsi.bus.1 (fsi.bus)
            /cfam (cfam)
...
This looks weird. I think you want to use address_space_rw().
...
have you looked at address_space_ldl() ?
