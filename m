...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 715EF586BA5
	for <lists+openbmc@lfdr.de>; Mon,  1 Aug 2022 15:14:36 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4LxJVy23f3z3c0g
	for <lists+openbmc@lfdr.de>; Mon,  1 Aug 2022 23:14:34 +1000 (AEST)
...
Received: from herzl.nuvoton.co.il (unknown [212.199.177.27])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4LxJV83wShz2xHk
	for <openbmc@lists.ozlabs.org>; Mon,  1 Aug 2022 23:13:49 +1000 (AEST)
Received: from NTILML01.nuvoton.com (ntil-fw [212.199.177.25])
	by herzl.nuvoton.co.il (8.13.8/8.13.8) with ESMTP id 271DDgfk022378
	for <openbmc@lists.ozlabs.org>; Mon, 1 Aug 2022 16:13:42 +0300
...
Received: from taln60.nuvoton.co.il (10.191.1.180) by NTHCCAS04.nuvoton.com
 ...
 Transport; Mon, 1 Aug 2022 21:13:39 +0800
Received: by taln60.nuvoton.co.il (Postfix, from userid 10070)
	id 4442A60365; Mon,  1 Aug 2022 16:13:39 +0300 (IDT)
From: Tomer Maimon <tmaimon77@gmail.com>
To: <openbmc@lists.ozlabs.org>
Subject: [PATCH linux dev-5.15 v1 2/2] pinctrl: nuvoton: add NPCM8XX pinctrl and GPIO driver
Date: Mon, 1 Aug 2022 16:13:31 +0300
Message-ID: <20220801131331.118697-3-tmaimon77@gmail.com>
...
---
 ...
 4 files changed, 2571 insertions(+), 1 deletion(-)
 create mode 100644 drivers/pinctrl/nuvoton/pinctrl-npcm8xx.c

diff --git a/drivers/pinctrl/Makefile b/drivers/pinctrl/Makefile
index 200073bcc2c1..da2d2e1b4e1f 100644
--- a/drivers/pinctrl/Makefile
+++ b/drivers/pinctrl/Makefile
@@ -57,7 +57,7 @@ obj-y				+= freescale/
...
index 48ba0469edda..3695c2df5f74 100644
--- a/drivers/pinctrl/nuvoton/Kconfig
+++ b/drivers/pinctrl/nuvoton/Kconfig
@@ -11,3 +11,16 @@ config PINCTRL_NPCM7XX
 	help
...
index 000000000000..5a21f720234b
--- /dev/null
...
+				npcm_gpio_set(&bank->gc,
+					      bank->base + NPCM8XX_GP_N_DBNCS0 + (DBNCS_offset * 4),
+					      debounce_select);
+				break;
+			}
+		} else {
