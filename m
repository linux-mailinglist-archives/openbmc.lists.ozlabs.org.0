...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id A8BF79486B6
	for <lists+openbmc@lfdr.de>; Tue,  6 Aug 2024 02:48:05 +0200 (CEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20230601 header.b=gsOAdvgt;
	dkim-atps=neutral
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4WdF5v4VH6z3cXt
	for <lists+openbmc@lfdr.de>; Tue,  6 Aug 2024 10:48:03 +1000 (AEST)
X-Original-To: openbmc@lists.ozlabs.org
Delivered-To: openbmc@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20230601 header.b=gsOAdvgt;
	dkim-atps=neutral
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized) smtp.mailfrom=gmail.com (client-ip=2607:f8b0:4864:20::d31; helo=mail-io1-xd31.google.com; envelope-from=stanley.chuys@gmail.com; receiver=lists.ozlabs.org)
Received: from mail-io1-xd31.google.com (mail-io1-xd31.google.com [IPv6:2607:f8b0:4864:20::d31])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4WdF5L3vDmz2ysd
	for <openbmc@lists.ozlabs.org>; Tue,  6 Aug 2024 10:47:32 +1000 (AEST)
Received: by mail-io1-xd31.google.com with SMTP id ca18e2360f4ac-81fdf584985so727539f.1
        for <openbmc@lists.ozlabs.org>; Mon, 05 Aug 2024 17:47:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1722905250; x=1723510050; darn=lists.ozlabs.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=Ip5BnSuh1fwnmIQPrerqhHwuzCyEwogMfiC+5PabGh8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1722905250; x=1723510050;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=Ip5BnSuh1fwnmIQPrerqhHwuzCyEwogMfiC+5PabGh8=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVNAjDnXej3tGCcNr3587llE3wXFOj83MASkaMUVL/YZ2VdV6QADIJPFEUiI0J2xYQcEkmPovAW4tpdNU7QuAWdWxeX80/uE0Q=
X-Gm-Message-State: AOJu0YzCTp/Ilu62kXeNJJedW99vrBauPL3c5BHBb4NCm1BVUiKMC8Wa
	kHDWSOownHnpu/1+zm2Ajwp4rVn7592Vc4IfEKcL6JfooTD2c8PM75w4gJyl+OcoTLlZnzPQMFR
	nIGU/iXmOVxK9XyM/gQyy7oCgml8=
X-Google-Smtp-Source: AGHT+IHAMONfim9p0GxrSE+a2WYdcNOOg/xJ1FwSfhKMxtc7o9uI9zoRf78jhrIvn4+mPS4Ne4DEp80cAYPVbaaV4cU=
X-Received: by 2002:a05:6e02:b46:b0:39a:f26b:3557 with SMTP id
 e9e14a558f8ab-39b1fc49697mr93178205ab.5.1722905249205; Mon, 05 Aug 2024
 17:47:29 -0700 (PDT)
MIME-Version: 1.0
References: <20240801071946.43266-1-yschu@nuvoton.com> <20240801071946.43266-3-yschu@nuvoton.com>
 <Zq0Ge097urOty5l+@lizhi-Precision-Tower-5810> <CAPwEoQNrGE8cgxEYxezZmFufpK3C18Cn9rw4mjQNSjtV-eWSrQ@mail.gmail.com>
 <ZrDtGcjfwEKcjyFm@lizhi-Precision-Tower-5810>
In-Reply-To: <ZrDtGcjfwEKcjyFm@lizhi-Precision-Tower-5810>
From: Stanley Chu <stanley.chuys@gmail.com>
Date: Tue, 6 Aug 2024 08:47:18 +0800
Message-ID: <CAPwEoQPs2NnbXwD1H=H3qirD=agPVL1cJ0ihyNJBaer_B81aww@mail.gmail.com>
...
On Mon, Aug 5, 2024 at 11:17=E2=80=AFPM Frank Li <Frank.li@nxp.com> wrote:
>
> On Mon, Aug 05, 2024 at 03:19:34PM +0800, Stanley Chu wrote:
> > On Sat, Aug 3, 2024 at 12:17=E2=80=AFAM Frank Li <Frank.li@nxp.com> wro=
te:
> > >
...
> > > > --- a/MAINTAINERS
> > > > +++ b/MAINTAINERS
> > > > @@ -2670,6 +2670,13 @@ F:     Documentation/userspace-api/media/dri=
vers/npcm-video.rst
...
> > > > diff --git a/drivers/i3c/master/Kconfig b/drivers/i3c/master/Kconfi=
g
...
> > > > +
> > > > +       This hardware is an instance of the SVC I3C controller; thi=
s
...
> > > > +
> > > >  config MIPI_I3C_HCI
> > > >       tristate "MIPI I3C Host Controller Interface driver (EXPERIME=
NTAL)"
> > > >       depends on I3C
> > > > diff --git a/drivers/i3c/master/Makefile b/drivers/i3c/master/Makef=
ile
> > > > index 3e97960160bc..3ed55113190a 100644
> > > > --- a/drivers/i3c/master/Makefile
> > > > +++ b/drivers/i3c/master/Makefile
> > > > @@ -3,4 +3,5 @@ obj-$(CONFIG_CDNS_I3C_MASTER)         +=3D i3c-mast=
er-cdns.o
...
> > > > diff --git a/drivers/i3c/master/npcm845-i3c-master.c b/drivers/i3c/=
master/npcm845-i3c-master.c
...
> > > > +#define   NPCM_I3C_MCONFIG_ODBAUD(x) FIELD_PREP(GENMASK(23, 16), (=
x))
...
> > > > +#define   NPCM_I3C_MCONFIG_I2CBAUD(x) FIELD_PREP(GENMASK(31, 28), =
(x))
> > > > +
...
> > > > +#define   NPCM_I3C_MSTATUS_STATE_DAA(x) (NPCM_I3C_MSTATUS_STATE(x)=
 =3D=3D 5)
> > > > +#define   NPCM_I3C_MSTATUS_STATE_IDLE(x) (NPCM_I3C_MSTATUS_STATE(x=
) =3D=3D 0)
> > > > +#define   NPCM_I3C_MSTATUS_STATE_SLVREQ(x) (NPCM_I3C_MSTATUS_STATE=
(x) =3D=3D 1)
> > > > +#define   NPCM_I3C_MSTATUS_STATE_IBIACK(x) (NPCM_I3C_MSTATUS_STATE=
(x) =3D=3D 6)
...
> > > > +#define   NPCM_I3C_MSTATUS_SLVSTART(x) FIELD_GET(NPCM_I3C_MINT_SLV=
START, (x))
> > > > +#define   NPCM_I3C_MSTATUS_MCTRLDONE(x) FIELD_GET(NPCM_I3C_MINT_MC=
TRLDONE, (x))
> > > > +#define   NPCM_I3C_MSTATUS_COMPLETE(x) FIELD_GET(NPCM_I3C_MINT_COM=
PLETE, (x))
> > > > +#define   NPCM_I3C_MSTATUS_RXPEND(x) FIELD_GET(NPCM_I3C_MINT_RXPEN=
D, (x))
> > > > +#define   NPCM_I3C_MSTATUS_TXNOTFULL(x) FIELD_GET(NPCM_I3C_MINT_TX=
NOTFULL, (x))
> > > > +#define   NPCM_I3C_MSTATUS_IBIWON(x) FIELD_GET(NPCM_I3C_MINT_IBIWO=
N, (x))
> > > > +#define   NPCM_I3C_MSTATUS_ERRWARN(x) FIELD_GET(NPCM_I3C_MINT_ERRW=
ARN, (x))
> > > > +#define   NPCM_I3C_MSTATUS_IBIADDR(x) FIELD_GET(GENMASK(30, 24), (=
x))
> > > > +
> > > > +#define NPCM_I3C_IBIRULES     0x08C
> > > > +#define   NPCM_I3C_IBIRULES_ADDR(slot, addr) FIELD_PREP(GENMASK(29=
, 0), \
> > > > +                                                    ((addr) & 0x3F=
) << ((slot) * 6))
...
> > > > +#define   NPCM_I3C_MDMACTRL_DMAWIDTH(x) FIELD_PREP(GENMASK(5, 4), =
(x))
...
> > > > +#define   NPCM_I3C_MDATACTRL_RXCOUNT(x) FIELD_GET(GENMASK(28, 24),=
 (x))
> > > > +#define   NPCM_I3C_MDATACTRL_TXCOUNT(x) FIELD_GET(GENMASK(20, 16),=
 (x))
...
> > >
> > > Above register layer out is very similar with svc-i3c-master.c, I sup=
pose
...
> > There are some reasons I decided to add a new driver for our own platfo=
rm.
...
>
> You can use quirk for errata workaround. I go though this driver, most pa=
rt
...
The major changes are as below in order to make ibi handling as fast
as possible.
- handle ibi in isr (svc-i3c-master handles ibi in work queue)
- handle ibi immediately while ibiwon occurs during master xfer.
These changes make call flow quite different, it's not compatible with
svc-i3c-master.c.
...
> > > > + * @addrs: Array containing the dynamic addresses of each attached=
 device
...
> > >
> > > > +
> > > > +static int npcm_i3c_master_wait_for_complete(struct npcm_i3c_maste=
r *master);
> > > > +static void npcm_i3c_master_stop_dma(struct npcm_i3c_master *maste=
r);
> > >
...
> > > > +                     dev_dbg(master->dev, "Warning condition: MSTA=
TUS 0x%08x, MERRWARN 0x%08x\n",
> > > > +                             mstatus, merrwarn);
> > > > +                     return false;
> > > > +             }
> > > > +
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_set_sda_skew(struct npcm_i3c_master *m=
aster, int skew)
> > > > +{
> > > > +     u32 val;
> > > > +
> > > > +     val =3D readl(master->regs + NPCM_I3C_MCONFIG) & ~NPCM_I3C_MC=
ONFIG_SKEW_MASK;
> > > > +     val |=3D NPCM_I3C_MCONFIG_SKEW(skew);
> > > > +     writel(val, master->regs + NPCM_I3C_MCONFIG);
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_enable_interrupts(struct npcm_i3c_mast=
er *master, u32 mask)
> > > > +{
> > > > +     writel(mask, master->regs + NPCM_I3C_MINTSET);
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_disable_interrupts(struct npcm_i3c_mas=
ter *master)
> > > > +{
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_clear_merrwarn(struct npcm_i3c_master =
*master)
> > > > +{
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_flush_fifo(struct npcm_i3c_master *mas=
ter)
> > > > +{
> > > > +     /* Flush FIFOs */
> > > > +     writel(NPCM_I3C_MDATACTRL_FLUSHTB | NPCM_I3C_MDATACTRL_FLUSHR=
B,
> > > > +            master->regs + NPCM_I3C_MDATACTRL);
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_flush_rx_fifo(struct npcm_i3c_master *=
master)
> > > > +{
> > > > +     writel(NPCM_I3C_MDATACTRL_FLUSHRB, master->regs + NPCM_I3C_MD=
ATACTRL);
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_reset_fifo_trigger(struct npcm_i3c_mas=
ter *master)
> > > > +{
> > > > +     u32 reg;
> > > > +
...
> > > > +     if (mandatory_byte)
> > > > +             ibi_ack_nack |=3D NPCM_I3C_MCTRL_IBIRESP_ACK_WITH_BYT=
E |
> > > > +                     NPCM_I3C_MCTRL_RDTERM(NPCM_I3C_MAX_IBI_PAYLOA=
D_SIZE);
> > > > +     else
> > > > +             ibi_ack_nack |=3D NPCM_I3C_MCTRL_IBIRESP_ACK_WITHOUT_=
BYTE;
> > > > +
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_nack_ibi(struct npcm_i3c_master *maste=
r)
> > > > +{
> > > > +     u32 reg;
> > > > +
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_emit_stop(struct npcm_i3c_master *mast=
er)
> > > > +{
> > > > +     u32 reg =3D readl(master->regs + NPCM_I3C_MSTATUS);
> > > > +
> > > > +     /* Do not emit stop in the IDLE or SLVREQ state */
> > > > +     if (NPCM_I3C_MSTATUS_STATE_IDLE(reg) || NPCM_I3C_MSTATUS_STAT=
E_SLVREQ(reg))
> > > > +             return;
> > > > +
> > > > +     /*
> > > > +      * The spurious IBI event may change controller state to IBIA=
CK, switch state
> > > > +      * to NORMACT before emitSTOP request.
> > > > +      */
> > > > +     if (NPCM_I3C_MSTATUS_STATE_IBIACK(reg)) {
> > > > +             npcm_i3c_master_nack_ibi(master);
> > > > +             writel(NPCM_I3C_MINT_IBIWON, master->regs + NPCM_I3C_=
MSTATUS);
> > > > +     }
> > > > +
> > > > +     writel(NPCM_I3C_MCTRL_REQUEST_STOP, master->regs + NPCM_I3C_M=
CTRL);
> > > > +     readl_poll_timeout(master->regs + NPCM_I3C_MSTATUS, reg,
> > > > +                        NPCM_I3C_MSTATUS_MCTRLDONE(reg), 0, 1000);
> > > > +
> > > > +     /*
> > > > +      * This delay is necessary after the emission of a stop, othe=
rwise eg.
> > > > +      * repeating IBIs do not get detected. There is a note in the=
 manual
> > > > +      * about it, stating that the stop condition might not be set=
tled
...
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_handle_ibi(struct npcm_i3c_master *mast=
er,
> > > > +                                  struct i3c_dev_desc *dev)
> > > > +{
> > > > +     struct npcm_i3c_i2c_dev_data *data =3D i3c_dev_get_master_dat=
a(dev);
...
> > > > +
> > > > +     if (!data) {
> > > > +             dev_err_ratelimited(master->dev, "No data for addr 0x=
%x\n",
> > > > +                     dev->info.dyn_addr);
> > > > +             goto no_ibi_pool;
> > > > +     }
> > > > +
> > > > +     if (!data->ibi_pool) {
> > > > +             dev_err_ratelimited(master->dev, "No ibi pool for add=
r 0x%x\n",
...
> > > > +
> > > > +     /*
> > > > +      * Sometimes I3C HW returns to IDLE state after IBIRCV comple=
ted,
> > > > +      * continue when state becomes IDLE.
> > > > +      */
> > > > +     ret =3D readl_relaxed_poll_timeout(master->regs + NPCM_I3C_MS=
TATUS, val,
> > > > +                                      NPCM_I3C_MSTATUS_COMPLETE(va=
l) |
> > > > +                                      NPCM_I3C_MSTATUS_STATE_IDLE(=
val),
> > > > +                                      0, 1000);
> > > > +     if (ret) {
> > > > +             dev_err(master->dev, "Timeout when polling for COMPLE=
TE\n");
...
> > > > +     }
> > > > +
> > > > +     while (NPCM_I3C_MSTATUS_RXPEND(readl(master->regs + NPCM_I3C_=
MSTATUS))  &&
...
> > > > +     readl_relaxed_poll_timeout(master->regs + NPCM_I3C_MSTATUS, v=
al,
...
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_handle_ibiwon(struct npcm_i3c_master *m=
aster, bool autoibi)
> > > > +{
...
> > > > +                     }
> > > > +                     /*
> > > > +                      * Wait for complete to make sure the subsequ=
ent emitSTOP
> > > > +                      * request will be performed in the correct s=
tate(NORMACT).
> > > > +                      */
> > > > +                     readl_relaxed_poll_timeout(master->regs + NPC=
M_I3C_MSTATUS, status,
> > > > +                                                NPCM_I3C_MSTATUS_C=
OMPLETE(status),
> > > > +                                                0, 1000);
...
> > > > +              * and sometimes produce dummy bytes. Flush the garba=
ge data.
> > > > +              */
> > > > +             if (NPCM_I3C_MSTATUS_RXPEND(status))
> > > > +                     npcm_i3c_master_flush_rx_fifo(master);
...
> > > > +
> > > > +     /*
> > > > +      * If an error happened, we probably got interrupted and the =
exchange
> > > > +      * timedout. In this case we just drop everything, emit a sto=
p and wait
...
\n");
> > > > +             /*
> > > > +              * No need to emit stop here because the caller shoul=
d do it
> > > > +              * if return error
> > > > +              */
> > > > +             ret =3D -EIO;
...
> > > > +                     i3c_master_queue_ibi(dev, master->ibi.tbq_slo=
t);
> > > > +                     master->ibi.tbq_slot =3D NULL;
> > > > +             }
> > > > +             break;
> > > > +     case NPCM_I3C_MSTATUS_IBITYPE_HOT_JOIN:
> > > > +             /* Emit stop to avoid the INVREQ error after DAA proc=
ess */
> > > > +             npcm_i3c_master_emit_stop(master);
...
> > > > +
> > > > +     /*
> > > > +      * IBIWON may be set before NPCM_I3C_MCTRL_REQUEST_AUTO_IBI, =
causing
> > > > +      * readl_relaxed_poll_timeout() to return immediately. Conseq=
uently,
> > > > +      * ibitype will be 0 since it was last updated only after the=
 8th SCL
> > > > +      * cycle, leading to missed client IBI handlers.
> > > > +      *
> > > > +      * Clear NPCM_I3C_MINT_IBIWON before sending NPCM_I3C_MCTRL_R=
EQUEST_AUTO_IBI.
> > > > +      */
> > > > +     writel(NPCM_I3C_MINT_IBIWON, master->regs + NPCM_I3C_MSTATUS)=
;
> > > > +
> > > > +     /* Acknowledge the incoming interrupt with the AUTOIBI mechan=
ism */
...
> > > > +     ret =3D readl_relaxed_poll_timeout_atomic(master->regs + NPCM=
_I3C_MSTATUS, val,
> > > > +                                      NPCM_I3C_MSTATUS_IBIWON(val)=
, 0, 1000);
> > > > +     if (ret) {
> > > > +             /* Cancel AUTOIBI if not started */
> > > > +             val =3D readl(master->regs + NPCM_I3C_MCTRL);
> > > > +             if (NPCM_I3C_MCTRL_REQUEST(val) =3D=3D NPCM_I3C_MCTRL=
_REQUEST_AUTO_IBI)
...
> > > > +}
> > > > +
> > > > +static irqreturn_t npcm_i3c_master_irq_handler(int irq, void *dev_=
id)
> > > > +{
> > > > +     struct npcm_i3c_master *master =3D (struct npcm_i3c_master *)=
dev_id;
> > > > +     u32 active =3D readl(master->regs + NPCM_I3C_MINTMASKED), mst=
atus;
> > > > +
> > > > +     if (NPCM_I3C_MSTATUS_COMPLETE(active)) {
> > > > +             /* Clear COMPLETE status before emit STOP */
> > > > +             writel(NPCM_I3C_MINT_COMPLETE, master->regs + NPCM_I3=
C_MSTATUS);
...
> > > > +                     /* Stop DMA to prevent receiving the data of =
other transaction */
...
> > > > +             writel(NPCM_I3C_MINT_SLVSTART, master->regs + NPCM_I3=
C_MSTATUS);
> > > > +
> > > > +             /* Read I3C state */
> > > > +             mstatus =3D readl(master->regs + NPCM_I3C_MSTATUS);
...
> > > > +                     /*
> > > > +                      * Workaround:
> > > > +                      * SlaveStart event under bad signals conditi=
on. SLVSTART bit in
> > > > +                      * MSTATUS may set even slave device doesn't =
holding I3C_SDA low,
> > > > +                      * but actual SlaveStart event may happened c=
oncurently in this
> > > > +                      * bad signals condition handler. Give a chan=
ce to check current
> > > > +                      * work state and intmask to avoid actual Sla=
veStart cannot be
> > > > +                      * trigger after we clear SlaveStart interrup=
t status.
> > > > +                      */
> > > > +
> > > > +                     /* Check if state change after we clear inter=
rupt status */
> > > > +                     active =3D readl(master->regs + NPCM_I3C_MINT=
MASKED);
> > > > +                     mstatus =3D readl(master->regs + NPCM_I3C_MST=
ATUS);
> > > > +
> > > > +                     if (NPCM_I3C_MSTATUS_STATE_SLVREQ(mstatus)) {
> > > > +                             if (!NPCM_I3C_MSTATUS_SLVSTART(active=
))
> > > > +                                     npcm_i3c_master_ibi_isr(maste=
r);
> > > > +                             /* else: handle interrupt in next tim=
e */
> > > > +                     }
> > > > +             }
> > > > +     }
...
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_bus_init(struct i3c_master_controller *=
m)
> > > > +{
...
> > > > +     unsigned int pp_high_period_ns, od_low_period_ns, i2c_period_=
ns;
...
> > > > +      */
> > > > +     if (master->scl_timing.i3c_pp_hi >=3D I3C_SCL_PP_PERIOD_NS_MI=
N &&
> > > > +         master->scl_timing.i3c_pp_lo >=3D master->scl_timing.i3c_=
pp_hi) {
> > > > +             ppbaud =3D DIV_ROUND_UP(master->scl_timing.i3c_pp_hi,=
 fclk_period_ns) - 1;
> > > > +             if (ppbaud > NPCM_I3C_MAX_PPBAUD)
> > > > +                     ppbaud =3D NPCM_I3C_MAX_PPBAUD;
> > > > +             pplow =3D DIV_ROUND_UP(master->scl_timing.i3c_pp_lo, =
fclk_period_ns)
> > > > +                     - (ppbaud + 1);
> > > > +             if (pplow > NPCM_I3C_MAX_PPLOW)
> > > > +                     pplow =3D NPCM_I3C_MAX_PPLOW;
> > > > +             bus->scl_rate.i3c =3D 1000000000 / (((ppbaud + 1) * 2=
 + pplow) * fclk_period_ns);
> > > > +     } else {
> > > > +             scl_period_ns =3D DIV_ROUND_UP(1000000000, bus->scl_r=
ate.i3c);
> > > > +             if (bus->scl_rate.i3c =3D=3D 10000000) {
> > > > +                     /* Workaround for npcm8xx: 40/60 ns */
> > > > +                     ppbaud =3D DIV_ROUND_UP(40, fclk_period_ns) -=
 1;
> > > > +                     pplow =3D DIV_ROUND_UP(20, fclk_period_ns);
> > > > +             } else {
> > > > +                     /* 50% duty-cycle */
> > > > +                     ppbaud =3D DIV_ROUND_UP((scl_period_ns / 2), =
fclk_period_ns) - 1;
> > > > +                     pplow =3D 0;
> > > > +             }
> > > > +             if (ppbaud > NPCM_I3C_MAX_PPBAUD)
...
> > > > +         master->scl_timing.i3c_od_lo >=3D I3C_SCL_OD_LOW_PERIOD_N=
S_MIN) {
> > > > +             if (master->scl_timing.i3c_od_hi =3D=3D pp_high_perio=
d_ns)
> > > > +                     odhpp =3D 1;
> > > > +             else
> > > > +                     odhpp =3D 0;
> > > > +             odbaud =3D DIV_ROUND_UP(master->scl_timing.i3c_od_lo,=
 pp_high_period_ns) - 1;
> > > > +     } else {
> > > > +             /* Set default OD timing: 1MHz/1000ns with 50% duty c=
ycle */
> > > > +             odhpp =3D 0;
...
> > > > +
> > > > +     i3c_scl_rate =3D 1000000000 / (((ppbaud + 1) * 2 + pplow) * f=
clk_period_ns);
> > > > +     i2c_scl_rate =3D 1000000000 / ((i2cbaud + 2) * od_low_period_=
ns);
> > > > +
...
> > > > +     dev_info(master->dev, "pp_sda_rd_skew=3D%d, pp_sda_wr_skew=3D=
%d\n",
...
ud >> 1) + 1) * od_low_period_ns,
> > > > +                     ((i2cbaud >> 1) + 1 + (i2cbaud % 2)) * od_low=
_period_ns);
> > > > +     dev_dbg(master->dev, "ppbaud=3D%d, pplow=3D%d, odbaud=3D%d, i=
2cbaud=3D%d\n",
...
> > > > +     info.pid =3D (NPCM_I3C_VENDORID_VID(reg) << 33) | readl(maste=
r->regs + NPCM_I3C_PARTNO);
> > > > +
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_bus_cleanup(struct i3c_master_controll=
er *m)
> > > > +{
> > > > +     struct npcm_i3c_master *master =3D to_npcm_i3c_master(m);
> > > > +
...
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_reserve_slot(struct npcm_i3c_master *ma=
ster)
> > > > +{
> > > > +     unsigned int slot;
> > > > +
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_release_slot(struct npcm_i3c_master *m=
aster,
> > > > +                                     unsigned int slot)
> > > > +{
> > > > +     master->free_slots |=3D BIT(slot);
...
> > > > +     data->ibi =3D -1;
> > > > +     data->index =3D slot;
> > > > +     master->addrs[slot] =3D dev->info.dyn_addr ? dev->info.dyn_ad=
dr :
> > > > +                                                dev->info.static_a=
ddr;
...
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_reattach_i3c_dev(struct i3c_dev_desc *d=
ev,
> > > > +                                        u8 old_dyn_addr)
> > > > +{
> > > > +     struct i3c_master_controller *m =3D i3c_dev_get_master(dev);
...
a(dev);
> > > > +
> > > > +     master->addrs[data->index] =3D dev->info.dyn_addr ? dev->info=
.dyn_addr :
> > > > +                                                       dev->info.s=
tatic_addr;
> > > > +
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_detach_i3c_dev(struct i3c_dev_desc *de=
v)
> > > > +{
> > > > +     struct npcm_i3c_i2c_dev_data *data =3D i3c_dev_get_master_dat=
a(dev);
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_detach_i2c_dev(struct i2c_dev_desc *de=
v)
> > > > +{
> > > > +     struct npcm_i3c_i2c_dev_data *data =3D i2c_dev_get_master_dat=
a(dev);
> > > > +     struct i3c_master_controller *m =3D i2c_dev_get_master(dev);
> > > > +     struct npcm_i3c_master *master =3D to_npcm_i3c_master(m);
> > > > +
...
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_readb(struct npcm_i3c_master *master, u=
8 *dst,
> > > > +                             unsigned int len)
> > > > +{
> > > > +     int ret, i;
...
> > > > +
> > > > +     for (i =3D 0; i < len; i++) {
> > > > +             ret =3D readl_poll_timeout_atomic(master->regs + NPCM=
_I3C_MSTATUS,
> > > > +                                             reg,
> > > > +                                             NPCM_I3C_MSTATUS_RXPE=
ND(reg),
> > > > +                                             0, 1000);
> > > > +             if (ret)
> > > > +                     return ret;
...
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_do_daa_locked(struct npcm_i3c_master *m=
aster,
...
> > > > +
> > > > +             /*
> > > > +              * Either one slave will send its ID, or the assignme=
nt process
> > > > +              * is done.
> > > > +              */
> > > > +             ret =3D readl_relaxed_poll_timeout_atomic(master->reg=
s + NPCM_I3C_MSTATUS,
> > > > +                                             reg,
> > > > +                                             NPCM_I3C_MSTATUS_RXPE=
ND(reg) |
> > > > +                                             NPCM_I3C_MSTATUS_MCTR=
LDONE(reg),
> > > > +                                             0, 1000);
> > > > +             if (ret)
> > > > +                     return ret;
...
> > > > +                     ret =3D npcm_i3c_master_handle_ibiwon(master,=
 false);
> > > > +                     if (ret) {
> > > > +                             dev_err(master->dev, "daa: handle ibi=
 event fail, ret=3D%d\n", ret);
> > > > +                             return ret;
> > > > +                     }
> > > > +                     continue;
...
> > > > +                     u8 data[6];
> > > > +
> > > > +                     /* Give the slave device a suitable dynamic a=
ddress */
> > > > +                     dyn_addr =3D i3c_master_get_free_addr(&master=
->base, last_addr + 1);
> > > > +                     if (dyn_addr < 0)
> > > > +                             return dyn_addr;
> > > > +                     writel(dyn_addr, master->regs + NPCM_I3C_MWDA=
TAB);
> > > > +
> > > > +                     /*
> > > > +                      * We only care about the 48-bit provisional =
ID yet to
> > > > +                      * be sure a device does not nack an address =
twice.
> > > > +                      * Otherwise, we would just need to flush the=
 RX FIFO.
> > > > +                      */
...
> > > > +                             /*
> > > > +                              * Sometimes the controller state is =
SLVREQ after
> > > > +                              * DAA request completed, treat it as=
 normal end.
> > > > +                              *
> > > > +                              * All devices received and acked the=
y dynamic
> > > > +                              * address, this is the natural end o=
f the DAA
> > > > +                              * procedure.
> > > > +                              */
> > > > +                             break;
...
> > > > +                             if (dev_nb =3D=3D 0) {
> > > > +                                     npcm_i3c_master_emit_stop(mas=
ter);
> > > > +                                     break;
> > > > +                             }
> > > > +
> > > > +                             /*
> > > > +                              * A slave device nacked the address,=
 this is
> > > > +                              * allowed only once, DAA will be sto=
pped and
> > > > +                              * then resumed. The same device is s=
upposed to
> > > > +                              * answer again immediately and shall=
 ack the
> > > > +                              * address this time.
> > > > +                              */
> > > > +                             if (prov_id[dev_nb] =3D=3D nacking_pr=
ov_id)
> > > > +                                     return -EIO;
> > > > +
> > > > +                             dev_nb--;
...
> > > > +             }
> > > > +
> > > > +             /* Wait for the slave to be ready to receive its addr=
ess */
> > > > +             ret =3D readl_poll_timeout_atomic(master->regs + NPCM=
_I3C_MSTATUS,
> > > > +                                             reg,
> > > > +                                             NPCM_I3C_MSTATUS_MCTR=
LDONE(reg) &&
> > > > +                                             NPCM_I3C_MSTATUS_STAT=
E_DAA(reg) &&
> > > > +                                             NPCM_I3C_MSTATUS_BETW=
EEN(reg),
> > > > +                                             0, 1000);
> > > > +             if (ret)
> > > > +                     return ret;
...
> > > > +     unsigned int mbyte_addr_ok =3D 0, mbyte_addr_ko =3D 0, nobyte=
_addr_ok =3D 0,
> > > > +             nobyte_addr_ko =3D 0;
...
> > > > +             if (I3C_BCR_DEVICE_ROLE(dev->info.bcr) =3D=3D I3C_BCR=
_I3C_MASTER) {
...
> > > > +
> > > > +             if (dev->info.bcr & I3C_BCR_IBI_PAYLOAD) {
> > > > +                     reg_mbyte |=3D NPCM_I3C_IBIRULES_ADDR(mbyte_a=
ddr_ok,
> > > > +                                                        dev->info.=
dyn_addr);
> > > > +
> > > > +                     /* IBI rules cannot be applied to devices wit=
h MSb=3D1 */
...
> > > > +                             mbyte_addr_ok++;
> > > > +             } else {
> > > > +                     reg_nobyte |=3D NPCM_I3C_IBIRULES_ADDR(nobyte=
_addr_ok,
> > > > +                                                         dev->info=
.dyn_addr);
> > > > +
...
> > > > +     if (!mbyte_addr_ko && mbyte_addr_ok <=3D NPCM_I3C_IBIRULES_AD=
DRS)
> > > > +             list_mbyte =3D true;
> > > > +
> > > > +     if (!nobyte_addr_ko && nobyte_addr_ok <=3D NPCM_I3C_IBIRULES_=
ADDRS)
> > > > +             list_nobyte =3D true;
> > > > +
...
> > > > +             return -ERANGE;
> > > > +
> > > > +     /* Pick the first list that can be handled by hardware, rando=
mly */
> > > > +     if (list_mbyte)
...
> > > > +      * Set SKEW bit to 1 before initiating a DAA, set SKEW bit to=
 0
...
> > > > +             if (ret)
> > > > +                     dev_err(master->dev, "Unable to add i3c dev@0=
x%x, err %d\n",
> > > > +                             addrs[i], ret);
> > > > +     }
> > > > +
...
> > > > +     if (ret)
> > > > +             dev_err(master->dev, "Cannot handle such a list of de=
vices");
> > > > +
> > > > +daa_out:
> > > > +     /* No Slave ACK */
...
> > > > +             if (offset + count > len) {
> > > > +                     dev_err(master->dev, "I3C receive length too =
long!\n");
> > > > +                     return -EINVAL;
> > > > +             }
> > > > +             for (i =3D 0; i < count; i++)
> > > > +                     in[offset + i] =3D readl(master->regs + NPCM_=
I3C_MRDATAB);
> > > > +
> > > > +             offset +=3D count;
> > > > +     }
...
> > > > +
> > > > +     while (offset < len) {
> > > > +             ret =3D readl_poll_timeout(master->regs + NPCM_I3C_MD=
ATACTRL,
> > > > +                                      mdctrl,
> > > > +                                      !(mdctrl & NPCM_I3C_MDATACTR=
L_TXFULL),
> > > > +                                      0, 1000);
> > > > +             if (ret)
> > > > +                     return ret;
...
> > > > +                     writel(out[offset++], master->regs + NPCM_I3C=
_MWDATAB);
> > > > +             else
> > > > +                     writel(out[offset++], master->regs + NPCM_I3C=
_MWDATABE);
...
> > > > +
> > > > +     /* Disable COMPLETE interrupt */
> > > > +     writel(NPCM_I3C_MINT_COMPLETE, master->regs + NPCM_I3C_MINTCL=
R);
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_write_dma_table(const u8 *src, u32 *ds=
t, int len)
> > > > +{
> > > > +     int i;
> > > > +
...
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_start_dma(struct npcm_i3c_master *maste=
r)
> > > > +{
...
> > > > +     val |=3D xfer->rnw ? NPCM_I3C_MDMACTRL_DMAFB(2) : NPCM_I3C_MD=
MACTRL_DMATB(2);
...
> > > > +      * Use 32-bit transfer width for TX (queal to MWDATAB registe=
r width)
> > > > +      */
...
> > > > +     int ret;
> > > > +
> > > > +     ret =3D wait_for_completion_timeout(&master->xfer_comp, msecs=
_to_jiffies(100));
> > > > +     if (!ret) {
> > > > +             dev_err(master->dev, "DMA transfer timeout (%s)\n", x=
fer->rnw ? "Read" : "write");
> > > > +             dev_err(master->dev, "mstatus =3D 0x%02x\n", readl(ma=
ster->regs + NPCM_I3C_MSTATUS));
> > > > +             return -ETIMEDOUT;
> > > > +     }
> > > > +
...
> > > > +             dev_dbg(master->dev, "short dma xfer(%s), want %d tra=
nsfer %d\n",
...
> > > > +            NPCM_I3C_MCTRL_RDTERM(NPCM_I3C_MAX_IBI_PAYLOAD_SIZE),
> > > > +            master->regs + NPCM_I3C_MCTRL);
> > > > +     ret =3D readl_poll_timeout(master->regs + NPCM_I3C_MSTATUS, r=
eg,
> > > > +                              NPCM_I3C_MSTATUS_MCTRLDONE(reg), 0, =
1000);
> > > > +     if (ret)
> > > > +             return -EIO;
> > > > +
...
> > > > +             if (ret) {
> > > > +                     dev_err(master->dev, "xfer read: handle ibi e=
vent fail, ret=3D%d\n", ret);
> > > > +                     return -EIO;
> > > > +             }
> > > > +
...
> > > > +                            bool rnw, unsigned int xfer_type, u8 a=
ddr,
> > > > +                            u8 *in, const u8 *out, unsigned int xf=
er_len,
...
> > > > +      * Prepare data before starting the transfer to fix this prob=
lem.
> > > > +      */
...
ATACTRL,
> > > > +                                      reg,
> > > > +                                      !(reg & NPCM_I3C_MDATACTRL_T=
XFULL),
> > > > +                                      0, 1000);
> > > > +             if (ret) {
> > > > +                     bus_locked =3D false;
> > > > +                     spin_unlock_irqrestore(&master->req_lock, fla=
gs);
> > > > +                     local_irq_enable();
> > > > +                     return ret;
> > > > +             }
...
> > > > +             space =3D NPCM_I3C_FIFO_SIZE - NPCM_I3C_MDATACTRL_TXC=
OUNT(reg);
> > > > +             count =3D xfer_len > space ? space : xfer_len;
> > > > +             for (i =3D 0; i < count; i++) {
> > > > +                     if (i =3D=3D xfer_len - 1)
> > > > +                             writel(out[0], master->regs + NPCM_I3=
C_MWDATABE);
> > > > +                     else
> > > > +                             writel(out[0], master->regs + NPCM_I3=
C_MWDATAB);
...
> > > > +                     dev_err(master->dev, "data is larger than buf=
fer size (%d)\n",
> > > > +                             MAX_DMA_COUNT);
> > > > +                     spin_unlock_irqrestore(&master->req_lock, fla=
gs);
...
> > > > +broadcast_start:
> > > > +     if (first && rnw) {
> > > > +             /* Send 7E first to avoid collision during master rea=
d */
...
1000);
> > > > +     if (ret) {
> > > > +             dev_err(master->dev, "xfer (%d) wait ctrl-done timeou=
t, mstatus=3D0x%02x\n",
> > > > +                     rnw, reg);
> > > > +             goto emit_stop;
> > > > +     }
...
> > > > +             if (rnw) {
> > > > +                     dev_err(master->dev, "xfer read: re-start but=
 ibiwon, mstatus=3D0x%02x\n",
> > > > +                                     mstatus);
> > > > +                     ret =3D -EIO;
> > > > +                     goto emit_stop;
> > > > +             }
...
> > > > +     }
> > > > +
> > > > +     /* Use COMPLETE interrupt as notification of transfer complet=
ion */
> > > > +     if (use_dma)
> > > > +             npcm_i3c_master_enable_interrupts(master, NPCM_I3C_MI=
NT_COMPLETE);
> > > > +
> > > > +     bus_locked =3D false;
> > > > +     spin_unlock_irqrestore(&master->req_lock, flags);
...
> > > > +
> > > > +     if (!use_dma) {
> > > > +             ret =3D readl_poll_timeout(master->regs + NPCM_I3C_MS=
TATUS, reg,
> > > > +                                      NPCM_I3C_MSTATUS_COMPLETE(re=
g), 0, 1000);
> > > > +             if (ret)
> > > > +                     goto emit_stop;
> > > > +
...
> > > > +npcm_i3c_master_alloc_xfer(struct npcm_i3c_master *master, unsigne=
d int ncmds)
> > > > +{
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_dequeue_xfer_locked(struct npcm_i3c_ma=
ster *master,
> > > > +                                            struct npcm_i3c_xfer *=
xfer)
> > > > +{
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_dequeue_xfer(struct npcm_i3c_master *m=
aster,
> > > > +                                     struct npcm_i3c_xfer *xfer)
> > > > +{
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_start_xfer_locked(struct npcm_i3c_mast=
er *master)
> > > > +{
...
> > > > +
> > > > +             ret =3D npcm_i3c_master_xfer(master, cmd->rnw, xfer->=
type,
> > > > +                                       cmd->addr, cmd->in, cmd->ou=
t,
> > > > +                                       cmd->len, &cmd->read_len,
> > > > +                                       cmd->continued, cmd->use_dm=
a, (i =3D=3D 0));
> > > > +             if (ret)
> > > > +                     break;
> > > > +     }
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_enqueue_xfer(struct npcm_i3c_master *m=
aster,
> > > > +                                     struct npcm_i3c_xfer *xfer)
> > > > +{
...
> > > > +
> > > > +static bool
> > > > +npcm_i3c_master_supports_ccc_cmd(struct i3c_master_controller *mas=
ter,
> > > > +                             const struct i3c_ccc_cmd *cmd)
> > > > +{
> > > > +     /* No software support for CCC commands targeting more than o=
ne slave */
> > > > +     return (cmd->ndests =3D=3D 1);
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_send_bdcast_ccc_cmd(struct npcm_i3c_mas=
ter *master,
...
> > > > +
> > > > +     buf[0] =3D ccc->id;
> > > > +     memcpy(&buf[1], ccc->dests[0].payload.data, ccc->dests[0].pay=
load.len);
> > > > +
...
> > > > +     if (!wait_for_completion_timeout(&xfer->comp, msecs_to_jiffie=
s(1000)))
...
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_send_direct_ccc_cmd(struct npcm_i3c_mas=
ter *master,
> > > > +                                           struct i3c_ccc_cmd *ccc=
)
> > > > +{
...
> > > > +}
> > > > +
> > > > +static int npcm_i3c_master_send_ccc_cmd(struct i3c_master_controll=
er *m,
...
> > > > +
> > > > +     if (broadcast)
> > > > +             ret =3D npcm_i3c_master_send_bdcast_ccc_cmd(master, c=
md);
> > > > +     else
> > > > +             ret =3D npcm_i3c_master_send_direct_ccc_cmd(master, c=
md);
> > > > +
> > > > +     if (ret) {
...
> > > > +             dev_err(master->dev, "IBI max payload %d should be < =
%d\n",
> > > > +                     dev->ibi->max_payload_len, NPCM_I3C_MAX_IBI_P=
AYLOAD_SIZE + 1);
> > > > +             return -ERANGE;
> > > > +     }
> > > > +
...
> > > > +
> > > > +     /* Clear the interrupt status */
> > > > +     writel(NPCM_I3C_MINT_SLVSTART, master->regs + NPCM_I3C_MSTATU=
S);
> > > > +     npcm_i3c_master_enable_interrupts(master, NPCM_I3C_MINT_SLVST=
ART);
> > > > +
> > > > +     return i3c_master_enec_locked(m, dev->info.dyn_addr, I3C_CCC_=
EVENT_SIR);
> > > > +}
> > > > +
...
> > > > +     int ret;
> > > > +
> > > > +     writel(NPCM_I3C_MINT_SLVSTART, master->regs + NPCM_I3C_MINTCL=
R);
> > > > +
> > > > +     ret =3D i3c_master_disec_locked(m, dev->info.dyn_addr, I3C_CC=
C_EVENT_SIR);
> > > > +
> > > > +     return ret;
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_recycle_ibi_slot(struct i3c_dev_desc *=
dev,
> > > > +                                         struct i3c_ibi_slot *slot=
)
> > > > +{
...
> > > > +};
> > > > +
> > > > +static int npcm_i3c_master_prepare_clks(struct npcm_i3c_master *ma=
ster)
> > > > +{
> > > > +     int ret =3D 0;
> > > > +
...
> > > > +}
> > > > +
> > > > +static void npcm_i3c_master_unprepare_clks(struct npcm_i3c_master =
*master)
> > > > +{
> > > > +     clk_disable_unprepare(master->pclk);
...
> > > > +             npcm_i3c_debugfs_dir =3D debugfs_create_dir("npcm_i3c=
", NULL);
> > > > +             if (!npcm_i3c_debugfs_dir)
> > > > +                     return;
> > > > +     }
...
> > > > +             return;
> > > > +
> > > > +     debugfs_create_file("debug", 0444, master->debugfs, master, &=
debug_fops);
> > > > +}
> > > > +
> > > > +static int npcm_i3c_setup_dma(struct platform_device *pdev, struct=
 npcm_i3c_master *master)
> > > > +{
...
> > > > +             return 0;
> > > > +
> > > > +     master->dma_regs =3D devm_platform_ioremap_resource_byname(pd=
ev, "dma");
> > > > +     if (IS_ERR(master->dma_regs))
> > > > +             return 0;
> > > > +
> > > > +     master->dma_ctl_regs =3D devm_platform_ioremap_resource_bynam=
e(pdev, "dma_ctl");
> > > > +     if (IS_ERR(master->dma_ctl_regs))
> > > > +             return 0;
> > > > +
> > > > +     /* DMA TX transfer width is 32 bits(MWDATAB width) for each b=
yte sent to I3C bus */
> > > > +     master->dma_tx_buf =3D dma_alloc_coherent(dev, MAX_DMA_COUNT =
* 4,
> > > > +                                             &master->dma_tx_addr,=
 GFP_KERNEL);
...
> > > > +             dma_free_coherent(master->dev, MAX_DMA_COUNT * 4, mas=
ter->dma_tx_buf,
> > > > +                               master->dma_tx_addr);
> > > > +             return -ENOMEM;
> > > > +     }
...
> > > > +     dma_ctl =3D GDMA_CH0_EN | GDMA_CH1_EN | (dma_conn + 1) << 16 =
| dma_conn;
...
> > > > +      */
> > > > +     writel(master->dma_tx_addr, master->dma_regs + NPCM_GDMA_SRCB=
(DMA_CH_TX));
...
> > > > +     writel(master->dma_rx_addr, master->dma_regs + NPCM_GDMA_DSTB=
(DMA_CH_RX));
> > > > +
> > > > +     return 0;
> > > > +}
...
> > > > +     ret =3D devm_request_irq(dev, master->irq, npcm_i3c_master_ir=
q_handler,
> > > > +                            IRQF_NO_SUSPEND, "npcm-i3c-irq", maste=
r);
> > > > +     if (ret)
...
> > > > +     master->ibi.slots =3D devm_kcalloc(&pdev->dev, master->ibi.nu=
m_slots,
...
> > > > +     if (!of_property_read_u32(dev->of_node, "i3c-pp-scl-hi-period=
-ns", &val))
> > > > +             master->scl_timing.i3c_pp_hi =3D val;
> > > > +
> > > > +     if (!of_property_read_u32(dev->of_node, "i3c-pp-scl-lo-period=
-ns", &val))
> > > > +             master->scl_timing.i3c_pp_lo =3D val;
> > > > +
> > > > +     if (!of_property_read_u32(dev->of_node, "i3c-pp-sda-rd-skew",=
 &val))
> > > > +             master->scl_timing.i3c_pp_sda_rd_skew =3D val;
> > > > +
> > > > +     if (!of_property_read_u32(dev->of_node, "i3c-pp-sda-wr-skew",=
 &val))
> > > > +             master->scl_timing.i3c_pp_sda_wr_skew =3D val;
> > > > +
> > > > +     if (!of_property_read_u32(dev->of_node, "i3c-od-scl-hi-period=
-ns", &val))
> > > > +             master->scl_timing.i3c_od_hi =3D val;
> > > > +
> > > > +     if (!of_property_read_u32(dev->of_node, "i3c-od-scl-lo-period=
-ns", &val))
...
ter->dma_tx_buf,
> > > > +                               master->dma_tx_addr);
> > > > +             dma_free_coherent(master->dev, MAX_DMA_COUNT, master-=
>dma_rx_buf,
> > > > +                               master->dma_rx_addr);
> > > > +     }
> > > > +     return 0;
