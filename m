...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 233D72143A
	for <lists+openbmc@lfdr.de>; Fri, 17 May 2019 09:29:14 +0200 (CEST)
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 4550KM47dNzDqSM
	for <lists+openbmc@lfdr.de>; Fri, 17 May 2019 17:29:11 +1000 (AEST)
...
Received: from mx0a-001b2d01.pphosted.com (mx0a-001b2d01.pphosted.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4550Jw1PSnzDqRJ
 for <openbmc@lists.ozlabs.org>; Fri, 17 May 2019 17:28:46 +1000 (AEST)
Received: from pps.filterd (m0098409.ppops.net [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id
 x4H7SU6P113225
 for <openbmc@lists.ozlabs.org>; Fri, 17 May 2019 03:28:44 -0400
Received: from e06smtp07.uk.ibm.com (e06smtp07.uk.ibm.com [195.75.94.103])
 by mx0a-001b2d01.pphosted.com with ESMTP id 2shpuac5jk-1
 (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=NOT)
 for <openbmc@lists.ozlabs.org>; Fri, 17 May 2019 03:28:40 -0400
Received: from localhost
 by e06smtp07.uk.ibm.com with IBM ESMTP SMTP Gateway: Authorized Use Only!
 Violators will be prosecuted
 for <openbmc@lists.ozlabs.org> from <vishwa@linux.vnet.ibm.com>;
 Fri, 17 May 2019 08:27:33 +0100
Received: from b06cxnps3074.portsmouth.uk.ibm.com (9.149.109.194)
 by e06smtp07.uk.ibm.com (192.168.101.137) with IBM ESMTP SMTP Gateway:
 Authorized Use Only! Violators will be prosecuted; 
 (version=TLSv1/SSLv3 cipher=AES256-GCM-SHA384 bits=256/256)
 Fri, 17 May 2019 08:27:30 +0100
Received: from d06av23.portsmouth.uk.ibm.com (d06av23.portsmouth.uk.ibm.com
 [9.149.105.59])
 by b06cxnps3074.portsmouth.uk.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id
 x4H7RTFF43384878
 (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
 Fri, 17 May 2019 07:27:29 GMT
Received: from d06av23.portsmouth.uk.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id A2D0CA4051;
 Fri, 17 May 2019 07:27:29 +0000 (GMT)
Received: from d06av23.portsmouth.uk.ibm.com (unknown [127.0.0.1])
 by IMSVA (Postfix) with ESMTP id C4743A404D;
 Fri, 17 May 2019 07:27:28 +0000 (GMT)
...
Date: Fri, 17 May 2019 12:57:28 +0530
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.6.1
MIME-Version: 1.0
In-Reply-To: <BL0PR2101MB0932823408EE75DB889F3C3DC80B0@BL0PR2101MB0932.namprd21.prod.outlook.com>
Content-Type: multipart/alternative;
 boundary="------------C985EA4290EF1AF8D63240CD"
Content-Language: en-US
X-TM-AS-GCONF: 00
x-cbid: 19051707-0028-0000-0000-0000036EA4F8
X-IBM-AV-DETECTION: SAVI=unused REMOTE=unused XFE=unused
x-cbparentid: 19051707-0029-0000-0000-0000242E42A7
Message-Id: <c6ac62c1-48b4-0df8-fbff-8172275ef8b1@linux.vnet.ibm.com>
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0
 ...
 scancount=1 engine=8.0.1-1810050000 definitions=main-1905170050
...
<html>
  ...
  <body text="#000000" bgcolor="#FFFFFF">
    ...
    <div class="moz-cite-prefix">On 5/17/19 12:53 PM, Neeraj Ladkani
      wrote:<br>
    </div>
    <blockquote type="cite"
cite="mid:BL0PR2101MB0932823408EE75DB889F3C3DC80B0@BL0PR2101MB0932.namprd21.prod.outlook.com">
      <meta http-equiv="Content-Type" content="text/html;
        charset=windows-1252">
      ...
      <div id="divRplyFwdMsg" dir="ltr"><font style="font-size:11pt"
          face="Calibri, sans-serif" color="#000000"><b>From:</b> vishwa
          <a class="moz-txt-link-rfc2396E" href="mailto:vishwa@linux.vnet.ibm.com">&lt;vishwa@linux.vnet.ibm.com&gt;</a><br>
          ...
          <div class="WordSection1">
            ...
            <ol style="margin-top:0in" start="1" type="1">
              <li class="MsoListParagraph"
                style="color:windowtext;margin-left:0in;mso-list:l7
                level1 lfo5">
              ...
              <ol style="margin-top:0in" start="1" type="a">
                <li class="MsoListParagraph"
                  ...
                  timestamps ( KCS, LAN, USB)<o:p></o:p></li>
                <li class="MsoListParagraph"
                  style="color:windowtext;margin-left:0in;mso-list:l7
                  level2 lfo5">
...
style="margin-left:1.5in;text-indent:-1.5in;mso-text-indent-alt:-9.0pt;mso-list:l7
              ...
              <!--[if !supportLists]--><span style="color:windowtext"><span
                ...
                style="color:windowtext">Request , Response, No of
...
style="margin-left:1.5in;text-indent:-1.5in;mso-text-indent-alt:-9.0pt;mso-list:l7
            ...
            <ol style="margin-top:0in" start="2" type="a">
              <li class="MsoListParagraph" style="mso-list:l2 level1
                lfo8">Count of assertions/deassertions of GPIO and
                ability to capture the state<o:p></o:p></li>
              <li class="MsoListParagraph" style="mso-list:l2 level1
                lfo8">timestamp of last assertion/deassertion of GPIO<o:p></o:p></li>
            </ol>
            <p class="MsoNormal"><span style="color:windowtext"><o:p> </o:p></span></p>
...
&lt;openbmc-bounces+neladk=microsoft.com@lists.ozlabs.org&gt;</a> <b>On
                    ...
                    <b>To:</b> Kun Yi <a class="moz-txt-link-rfc2396E"
                      href="mailto:kunyi@google.com"
                      moz-do-not-send="true">
                      &lt;kunyi@google.com&gt;</a>; OpenBMC Maillist <a
            ...
            <p><br>
              ...
              ? We could hook a repair-binary to take the action.<o:p></o:p></p>
            <p><br>
                  ...
                  <div>
                    ...
                    <div>
                      <p class="MsoNormal">This topic has been brought
                        ...
                        can provide immediate and direct benefits.<o:p></o:p></p>
                    </div>
                    <div>
                      <p class="MsoNormal"><o:p> </o:p></p>
                    </div>
                    ...
                    <div>
                      <p class="MsoNormal">The essentials I want are
                        ...
                        test metric for rolling out new BMC software.<o:p></o:p></p>
                    </div>
                    <div>
                      <p class="MsoNormal"><o:p> </o:p></p>
                    </div>
                    <div>
                      <p class="MsoNormal">Looking at the host IPMI
                        ...
                        Time to read the source code I guess.<o:p></o:p></p>
                    </div>
                    <div>
                      <p class="MsoNormal"><o:p> </o:p></p>
                    </div>
                    <div>
                      <p class="MsoNormal">Another idea would be to
                        ...
                        harder due to fragmentation of IPMI libraries.<o:p></o:p></p>
                    </div>
                    <div>
                      <p class="MsoNormal"><o:p> </o:p></p>
                    </div>
