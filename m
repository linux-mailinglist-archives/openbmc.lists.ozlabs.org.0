...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id C086A5F990
	for <lists+openbmc@lfdr.de>; Thu,  4 Jul 2019 16:03:02 +0200 (CEST)
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 45ffnb63MjzDqZy
	for <lists+openbmc@lfdr.de>; Fri,  5 Jul 2019 00:02:59 +1000 (AEST)
...
Authentication-Results: lists.ozlabs.org; dkim=pass (2048-bit key;
 unprotected) header.d=google.com header.i=@google.com header.b="ZJWWY+y3"; 
 dkim-atps=neutral
Received: from mail-pf1-x42f.google.com (mail-pf1-x42f.google.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 45ffj01mHtzDqLf
 for <openbmc@lists.ozlabs.org>; Thu,  4 Jul 2019 23:58:56 +1000 (AEST)
Received: by mail-pf1-x42f.google.com with SMTP id y15so2992283pfn.5
 for <openbmc@lists.ozlabs.org>; Thu, 04 Jul 2019 06:58:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=gGjQWWvmlxguRlzPJQI1bPxe4FRAk/KDB6Rds2dV5y8=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=gGjQWWvmlxguRlzPJQI1bPxe4FRAk/KDB6Rds2dV5y8=;
 b=
X-Gm-Message-State: APjAAAUvTn4+N9HCewnlci0qNCF3yPsWaGWauC0neYgewA7XT67H8kdD
 ANL8DhBeMm3yiYoQ8NR+VcgwWIQCzekQrP+wNmZ32w==
X-Google-Smtp-Source: APXvYqysufDdUQ+TF/HnQOBP1l76gShaF/768tGgqOIOEgL70ZlL5wWjYe7LGja42wvu3npCGsgvrsa8Rn9QILzwsz4=
X-Received: by 2002:a63:1f1f:: with SMTP id f31mr14061684pgf.353.1562248728861; 
 Thu, 04 Jul 2019 06:58:48 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <53220789ed064fa09ed23424cc099b77@lenovo.com>
From: Patrick Venture <venture@google.com>
Date: Thu, 4 Jul 2019 06:58:37 -0700
Message-ID: <CAO=notwJTb8gWnZdRVs1Uebdkudnw+fzVbU6PggxT4aqFnKjeg@mail.gmail.com>
Subject: Re: [External] Re: Clarify some questions about in-band firmware
 update
To: Andrew MS1 Peng <pengms1@lenovo.com>
Content-Type: multipart/alternative; boundary="00000000000089334f058cdb6022"
...
<div dir=3D"ltr" class=3D"gmail_attr">On Thu, Jul 4, 2019 at 5:19 AM Andrew=
...
<div lang=3D"ZH-CN">
<div class=3D"gmail-m_-8411625341099404742WordSection1">
...
lack"><a href=3D"https://github.com/openbmc/docs/blob/master/development/de=
v-environment.md#download-and-install-sdk" target=3D"_blank"><span style=3D=
"color:black">https://github.com/openbmc/docs/blob/master/development/dev-e=
nvironment.md#download-and-install-sdk</span></a>
 =C2=A0to set up my OpenBmc SD</span><span lang=3D"EN-US" style=3D"font-fam=
ily:Calibri,sans-serif;color:black">K
</span><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;color:b=
lack">environment</span><span lang=3D"EN-US" style=3D"font-family:Calibri,s=
ans-serif;color:black">, but it seems to be different from yours since your=
 SDK environment has
</span><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif">packag=
egroup-core-standalone-sdk-target.bbappend file</span><span lang=3D"EN-US" =
style=3D"font-family:Calibri,sans-serif;color:black">. I would like to buil=
d your SDK environment to test, could
 you give me some clue or guideline to set up the environment?</span></p></=
div></div></blockquote><div><br></div><div>The file to which you&#39;re ref=
erring is not special to my environment and it&#39;s part of openbmc.=C2=A0=
 I added ipmi-blob-tool to it so that I wouldn&#39;t have to build it ahead=
 of building burn_my_bmc.=C2=A0 I provided the patch in my email so you cou=
ld make the same change.</div><div><br></div><div>I didn&#39;t follow those=
 instructions because I don&#39;t know when the last build was of the SDK t=
hat&#39;s published there.=C2=A0 But you can build it yourself trivially:</=
div><div><br></div><div>$ git clone=C2=A0<a href=3D"https://github.com/open=
bmc/openbmc.git">https://github.com/openbmc/openbmc.git</a></div><div>$ pus=
hd openbmc</div><div>### apply the patch or change I mentioned</div><div>$ =
TEMPLATECONF=3Dmeta-phosphor/conf source oe-init-build-env<br>$ umask a+rx,=
u+rwx<br>$ MACHINE=3Dqemux86-64 bitbake obmc-phosphor-image -c populate_sdk=
<br></div><div>### wait while it builds everything</div><div>$ SDK_DIR=3D/o=
pt/openbmc-phosphor/2.7.0<br>$ sudo ./tmp/deploy/sdk/<a href=3D"http://oeco=
re-x86_64-core2-64-toolchain-nodistro.0.sh">oecore-x86_64-core2-64-toolchai=
n-nodistro.0.sh</a> -d $SDK_DIR<br></div><div>### let it install the SDK</d=
iv><div>$ source $SDK_DIR/environment-setup-core2-64-openbmc-linux<br></div=
><div>$ git clone=C2=A0<a href=3D"https://github.com/openbmc/phosphor-ipmi-=
flash">https://github.com/openbmc/phosphor-ipmi-flash</a><br></div><div>$ p=
ushd phosphor-ipmi-flash<br></div><div>$ export OECORE_TARGET_SYSROOT=3D$SD=
K_DIR/sysroots/core2-64-openbmc-linux<br>$ autoreconf -if<br></div><div></d=
iv><div></div><div>$ ./configure --enable-oe-sdk --host &quot;$(uname -m)&q=
uot; --disable-build-bmc-blob-handler AR=3Dx86_64-openbmc-linux-gcc-ar RANL=
IB=3Dx86_64-openbmc-linux-gcc-ranlib<br></div><div>### and it&#39;s built<b=
r></div><div>$ popd</div><div>$ popd</div><div><br></div><div>Like I said t=
hough, you don&#39;t need to use the SDK at all to build it.=C2=A0 You can =
just build it on your development workstation following the instructions in=
 the README and it&#39;ll take a lot less time.</div><div><br></div><div>=
=C2=A0</div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px 0px 0=
.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div lang=3D"=
ZH-CN"><div class=3D"gmail-m_-8411625341099404742WordSection1"><p class=3D"=
MsoNormal"><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;col=
or:black"><u></u><u></u></span></p>
<p class=3D"MsoNormal"><span lang=3D"EN-US" style=3D"font-family:Calibri,sa=
ns-serif;color:black"><u></u>=C2=A0<u></u></span></p>
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"margin-l=
eft:21pt">
<u></u><span lang=3D"EN-US" style=3D"font-family:Wingdings;color:black"><sp=
an>l<span style=3D"font:7pt &quot;Times New Roman&quot;">=C2=A0
</span></span></span><u></u><b><span lang=3D"EN-US" style=3D"font-family:Ca=
libri,sans-serif;color:black">My SDK
</span></b><b><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;=
color:black">environment setup procedure</span></b><b><span lang=3D"EN-US" =
style=3D"font-family:Calibri,sans-serif;color:black"><u></u><u></u></span><=
/b></p>
<p class=3D"MsoNormal" style=3D"text-indent:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">## Fetch=
 the OpenBmc x86-64 toolchain
<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">1. wget =
...
-64-toolchain-nodistro.0.sh" target=3D"_blank">https://openpower.xyz/job/op=
enbmc-build-sdk/distro=3Dubuntu,target=3Dqemux86-64/lastSuccessfulBuild/art=
ifact/deploy/sdk/oecore-x86_64-core2-64-toolchain-nodistro.0.sh</a><u></u><=
u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver"><u></u>=
=C2=A0<u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">## insta=
ll toolchain<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">2. run .=
/<a href=3D"http://oecore-x86_64-core2-64-toolchain-nodistro.0.sh" target=
=3D"_blank">oecore-x86_64-core2-64-toolchain-nodistro.0.sh</a>
<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver"><u></u>=
=C2=A0<u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">## run s=
ource env<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">3. sourc=
e ~/SDK/oecore-x86_64/environment-setup-core2-64-openbmc-linux<u></u><u></u=
></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver"><u></u>=
=C2=A0<u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">## Fetch=
 source code then compile ipmi-blob-tool and phosphor-ipmi-flash=C2=A0
<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">4.1 git =
clone <a href=3D"https://github.com/openbmc/ipmi-blob-tool" target=3D"_blan=
k">https://github.com/openbmc/ipmi-blob-tool</a><u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">=C2=A0=
=C2=A0 4.1.1 cd=C2=A0 ipmi-blob-tool<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">=C2=A0=
=C2=A0 4.1.2 ./bootstrap.sh<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">=C2=A0=
=C2=A0 4.1.3 ./configure --prefix=3D/home/pengms1/SDK/OpenBmc/rootfs --buil=
d=3Dx86_64-linux
 --host=3Dx86_64-openbmc-linux -with-libtool-sysroot=3D/home/pengms1/SDK/oe=
core-x86_64/sysroots/core2-64-openbmc-linux/ -enable-shared --enable-static
<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">=C2=A0=
=C2=A0=C2=A04.1.4 make &amp;&amp; make install<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">4.2 git =
clone <a href=3D"https://github.com/openbmc/phosphor-ipmi-flash" target=3D"=
_blank">https://github.com/openbmc/phosphor-ipmi-flash</a><u></u><u></u></s=
pan></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">=C2=A0=
=C2=A0=C2=A0 4.2.1 cd=C2=A0 phosphor-ipmi-flash<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">=C2=A0=
=C2=A0=C2=A0 4.2.2 ./bootstrap.sh<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">=C2=A0=
=C2=A0=C2=A0 4.2.3 export=C2=A0 =C2=A0PKG_CONFIG_PATH=3D&quot;/home/pengms1=
/SDK/oecore-x86_64/sysroots/core2-64-openbmc-linux/usr/lib/pkgconfig:/home/=
pengms1/SDK/oecore-x86_64/sysroots/core2-64-openbmc-linux/usr/share/pkgconf=
ig:/home/pengms1/SDK/OpenBmc/rootfs/lib/pkgconfig&quot;<u></u><u></u></span=
></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">=C2=A0=
=C2=A0=C2=A0 4.2.4 ./configure --prefix=3D/home/pengms1/SDK/OpenBmc/rootfs =
--build=3Dx86_64-linux
 --host=3Dx86_64-openbmc-linux=C2=A0 -with-libtool-sysroot=3D/home/pengms1/=
SDK/oecore-x86_64/sysroots/core2-64-openbmc-linux/=C2=A0 --disable-build-bm=
c-blob-handler<u></u><u></u></span></p>
<p class=3D"MsoNormal" style=3D"margin-left:12pt"><span lang=3D"EN-US" styl=
e=3D"font-family:Calibri,sans-serif;color:black;background:silver">=C2=A0=
=C2=A0=C2=A0 4.2.5=C2=A0 make CPPFLAGS=3D&quot;-I /home/pengms1/SDK/OpenBmc=
/rootfs/include/&quot;
 LDFLAGS=3D&quot;-L/home/pengms1/SDK/OpenBmc/rootfs/lib -lipmiblob&quot;</s=
pan><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;color:blac=
k"><u></u><u></u></span></p>
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"margin-l=
eft:21pt">
<u></u><span lang=3D"EN-US" style=3D"font-family:Wingdings;color:black"><sp=
...
libri,sans-serif;color:black">Compile status</span></b><b><span lang=3D"EN-=
US" style=3D"font-family:Calibri,sans-serif;color:black"><u></u><u></u></sp=
an></b></p>
<table class=3D"gmail-m_-8411625341099404742MsoTableGrid" border=3D"1" cell=
spacing=3D"0" cellpadding=3D"0" style=3D"margin-left:21pt;border-collapse:c=
ollapse;border:none">
<tbody>
<tr>
<td width=3D"334" valign=3D"top" style=3D"width:250.55pt;border:1pt solid w=
indowtext;background:yellow;padding:0cm 5.4pt">
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"text-ind=
ent:0cm"><b><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;co=
lor:black">Source code hash id<u></u><u></u></span></b></p>
</td>
...
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"text-ind=
ent:0cm"><b><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;co=
lor:black">Compile Status<u></u><u></u></span></b></p>
</td>
<td width=3D"167" valign=3D"top" style=3D"width:124.95pt;border-top:1pt sol=
id windowtext;border-right:1pt solid windowtext;border-bottom:1pt solid win=
dowtext;border-left:none;background:yellow;padding:0cm 5.4pt">
...
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"text-ind=
ent:0cm"><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;color=
:black">c37fe1e938238a10520ff6d120ccf5194ff60fa2<u></u><u></u></span></p>
</td>
...
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"text-ind=
ent:0cm"><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;color=
:black">Compile successful<u></u><u></u></span></p>
</td>
<td width=3D"167" valign=3D"top" style=3D"width:124.95pt;border-top:none;bo=
rder-left:none;border-bottom:1pt solid windowtext;border-right:1pt solid wi=
ndowtext;padding:0cm 5.4pt">
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"text-ind=
ent:0cm"><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;color=
:black">successful.log<u></u><u></u></span></p>
</td>
</tr>
<tr>
<td width=3D"334" valign=3D"top" style=3D"width:250.55pt;border-right:1pt s=
...
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"text-ind=
ent:0cm"><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;color=
:black">33311b47b3b656cfc16568b4b971730cb79130bc<u></u><u></u></span></p>
</td>
<td width=3D"167" valign=3D"top" style=3D"width:124.95pt;border-top:none;bo=
rder-left:none;border-bottom:1pt solid windowtext;border-right:1pt solid wi=
ndowtext;padding:0cm 5.4pt">
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"text-ind=
ent:0cm"><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;color=
:black">Compile failed<u></u><u></u></span></p>
</td>
<td width=3D"167" valign=3D"top" style=3D"width:124.95pt;border-top:none;bo=
rder-left:none;border-bottom:1pt solid windowtext;border-right:1pt solid wi=
ndowtext;padding:0cm 5.4pt">
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"text-ind=
ent:0cm"><span lang=3D"EN-US" style=3D"font-family:Calibri,sans-serif;color=
:black">failed.log<u></u><u></u></span></p>
</td>
</tr>
</tbody>
</table>
<p class=3D"gmail-m_-8411625341099404742MsoListParagraph" style=3D"margin-l=
eft:21pt;text-indent:0cm"><b><span lang=3D"EN-US" style=3D"font-family:Cali=
bri,sans-serif;color:black"><u></u>=C2=A0<u></u></span></b></p>
<p class=3D"MsoNormal"><span lang=3D"EN-US" style=3D"font-family:Calibri,sa=
...
d to see how you&#39;re building it, not just the failure output.=C2=A0 How=
 are you configuring it to build?=C2=A0 What changes have you made to the r=
ecipe?<u></u><u></u></span></p>
</div>
<div>
<p class=3D"MsoNormal"><span lang=3D"EN-US"><u></u>=C2=A0<u></u></span></p>
</div>
...
t so it&#39;ll build properly given the instructions specified in the READM=
E.=C2=A0 There&#39;s a common base library used to store
 the common strings, etc, which are what you&#39;re seeing missing in the o=
utput.=C2=A0 Basically, I&#39;d need to see more output, the commands that =
are running before the errors.<u></u><u></u></span></p>
</div>
</div>
</div>
</blockquote>
...
eed to build in that environment, you can build this without it.=C2=A0 The =
steps on the README were written while building it in
 a ubuntu docker instance that had nothing installed (then installed git, g=
cc, etc).<u></u><u></u></span></p>
</div>
</div>
</div>
</blockquote>
...
span></p>
<table class=3D"gmail-m_-8411625341099404742MsoNormalTable" border=3D"0" ce=
llspacing=3D"0" cellpadding=3D"0" style=3D"border-collapse:collapse">
<tbody>
<tr>
<td width=3D"234" valign=3D"top" style=3D"width:232.4pt;border:1pt solid wi=
ndowtext;background:yellow;padding:0cm 5.4pt">
<p class=3D"MsoNormal"><span lang=3D"EN-US" style=3D"font-family:Calibri,sa=
ns-serif">OpenBmc Setting</span><span lang=3D"EN-US"><u></u><u></u></span><=
/p>
</td>
<td width=3D"287" valign=3D"top" style=3D"width:263.35pt;border-top:1pt sol=
id windowtext;border-right:1pt solid windowtext;border-bottom:1pt solid win=
dowtext;border-left:none;background:yellow;padding:0cm 5.4pt">
<p class=3D"MsoNormal"><span lang=3D"EN-US" style=3D"font-family:Calibri,sa=
...
<td width=3D"140" valign=3D"top" style=3D"width:120.5pt;border-top:1pt soli=
...
<td width=3D"234" rowspan=3D"3" valign=3D"top" style=3D"width:232.4pt;borde=
...
<td width=3D"287" valign=3D"top" style=3D"width:263.35pt;border-top:none;bo=
rder-left:none;border-bottom:1pt solid windowtext;border-right:1pt solid wi=
...
<td width=3D"140" rowspan=3D"3" valign=3D"top" style=3D"width:120.5pt;borde=
...
<p class=3D"gmail-m_-8411625341099404742gmail-m1788754371567513735gmail-m64=
36252274273416049gmail-m-4871403681716629123gmail-m5865277644764564145gmail=
-m5232517683823064206gmail-m-6091798217660211465gmail-m-7106965077525685122=
msolistparagraph" style=3D"margin-left:18pt">
