...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 44741554383
	for <lists+openbmc@lfdr.de>; Wed, 22 Jun 2022 09:16:54 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4LSZSW4481z3bqf
	for <lists+openbmc@lfdr.de>; Wed, 22 Jun 2022 17:16:43 +1000 (AEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=google.com header.i=@google.com header.a=rsa-sha256 header.s=20210112 header.b=LslBSNuH;
	dkim-atps=neutral
X-Original-To: openbmc@lists.ozlabs.org
Delivered-To: openbmc@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized) smtp.mailfrom=google.com (client-ip=2a00:1450:4864:20::42c; helo=mail-wr1-x42c.google.com; envelope-from=davidgow@google.com; receiver=<UNKNOWN>)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=google.com header.i=@google.com header.a=rsa-sha256 header.s=20210112 header.b=LslBSNuH;
	dkim-atps=neutral
Received: from mail-wr1-x42c.google.com (mail-wr1-x42c.google.com [IPv6:2a00:1450:4864:20::42c])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4LSZS33n72z3bkP
	for <openbmc@lists.ozlabs.org>; Wed, 22 Jun 2022 17:16:18 +1000 (AEST)
Received: by mail-wr1-x42c.google.com with SMTP id q9so22023005wrd.8
        for <openbmc@lists.ozlabs.org>; Wed, 22 Jun 2022 00:16:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=UPXYrFND8QHdmaxWCpuA8xQCIq18P30HjsKkryOkP4Y=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=UPXYrFND8QHdmaxWCpuA8xQCIq18P30HjsKkryOkP4Y=;
        b=
X-Gm-Message-State: AJIora812L9GAARZTHt7F43NxIwWmwAB/g+59P2RZISt5aGM32zxUFVZ
	U/lvbmzZCb+psdPtA2EhNEZbXH6ND5YCrgcTFMhHww==
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="000000000000be006105e2041c5c"
