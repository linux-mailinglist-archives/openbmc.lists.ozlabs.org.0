...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id DDF3D1028DE
	for <lists+openbmc@lfdr.de>; Tue, 19 Nov 2019 17:07:59 +0100 (CET)
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 47HW244QSZzDqgV
	for <lists+openbmc@lfdr.de>; Wed, 20 Nov 2019 03:07:56 +1100 (AEDT)
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 unprotected) header.d=yadro.com header.i=@yadro.com header.b="DT+P+nd0"; 
 dkim-atps=neutral
Received: from mta-01.yadro.com (mta-02.yadro.com [89.207.88.252])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by lists.ozlabs.org (Postfix) with ESMTPS id 47HW112ZPHzDqS2
 for <openbmc@lists.ozlabs.org>; Wed, 20 Nov 2019 03:07:01 +1100 (AEDT)
Received: from localhost (unknown [127.0.0.1])
 by mta-01.yadro.com (Postfix) with ESMTP id 314FE43B4E
 for <openbmc@lists.ozlabs.org>; Tue, 19 Nov 2019 16:06:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=yadro.com; h=
 ...
 :received:received; s=mta-01; t=1574179609; x=1575994010; bh=A5F
 fNErVD/0J/hUBmesLVnnsVXlbtd4eGQOXmU8QXmU=; b=DT+P+nd07ntA7ThGku3
 I5/2s/NwNbqQMFE4be4P/tMD3B83HDFh30lLdJMNThZtLOIj/mmRgjunz/RKptCv
 BaARr7Bszp6jzDdrW09zIdD/U8377jm1nS5Eq81utr3A4/H23DuPYoYDD+ROp63U
 Uob/dQqpLOSRRjHEq3mWIqF0=
X-Virus-Scanned: amavisd-new at yadro.com
Received: from mta-01.yadro.com ([127.0.0.1])
 by localhost (mta-01.yadro.com [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id pM0BRVMrab6d for <openbmc@lists.ozlabs.org>;
 Tue, 19 Nov 2019 19:06:49 +0300 (MSK)
Received: from T-EXCH-02.corp.yadro.com (t-exch-02.corp.yadro.com
 [172.17.10.102])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
 (No client certificate requested)
 by mta-01.yadro.com (Postfix) with ESMTPS id E79F4438D1
 for <openbmc@lists.ozlabs.org>; Tue, 19 Nov 2019 19:06:49 +0300 (MSK)
...
Organization: YADRO
Message-ID: <29e500ed-2f4c-5e44-02fc-80b44e1c6623@yadro.com>
Date: Tue, 19 Nov 2019 19:06:49 +0300
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.8.0
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 protocol="application/pgp-signature";
 boundary="UiS3xzftLplLeH8QBrn6yKoPajRL7FUnE"
...
--UiS3xzftLplLeH8QBrn6yKoPajRL7FUnE
Content-Type: multipart/mixed; boundary="f2WJ66tU4vYDz0PTL8wEqowh8iM10rOq7";
...
--f2WJ66tU4vYDz0PTL8wEqowh8iM10rOq7
Content-Type: multipart/mixed;
 boundary="------------023BB994F6F050715E8B72A2"
Content-Language: en-US

This is a multi-part message in MIME format.
--------------023BB994F6F050715E8B72A2
...
We tried openbmc/openbmc/master branch and got errors log from booted Ope=
nBMC
(attached) regarding unavailability of power control, and also a netdev w=
atchdog
timeout and a kernel crash.

We tried Intel-BMC/master branch and got build errors, failed to build.

We tried Intel-BMC/clean_builds branch and ended up with an almost clean =
boot
log, but no 'obmcutil' and no apparent way to start the host. The netdev
watchdog also crashed.

Is there any instruction on how to properly build OpenBMC for s2600wf? Is=
 it
...

aUtAEI+nmrOyotHVRMK0
=JeYP
-----END PGP SIGNATURE-----
