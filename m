...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 58D8950F22E
	for <lists+openbmc@lfdr.de>; Tue, 26 Apr 2022 09:21:47 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4KnYGd1qFyz3bbL
	for <lists+openbmc@lfdr.de>; Tue, 26 Apr 2022 17:21:45 +1000 (AEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (1024-bit key; unprotected) header.d=bewilderbeest.net header.i=@bewilderbeest.net header.a=rsa-sha256 header.s=thorn header.b=Yr7vL54C;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 ...
 header.a=rsa-sha256 header.s=thorn header.b=Yr7vL54C; 
 dkim-atps=neutral
Received: from thorn.bewilderbeest.net (thorn.bewilderbeest.net
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4KnYCb1vLBz2xgN
...
Received: from hatter.bewilderbeest.net (174-21-187-98.tukw.qwest.net
 ...
 by thorn.bewilderbeest.net (Postfix) with ESMTPSA id 9695D717;
 Tue, 26 Apr 2022 00:19:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=bewilderbeest.net;
 s=thorn; t=1650957543;
 bh=28I4pDN7Mp9e1pg7WNRjxyeaRfujhnuEu8iEUaUC6Dc=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=Yr7vL54CijjyNbOyJD9Hx7+7jPoCFJ5wpCiXFXqZVJWZHCQl4vFAQmp5GLwmK+gIh
 OwwoPJt/V3eu5srlh0uR4Tzk82BB9UyS2ESluQDI1oA1bXCmXJySKd6pQLQqk6/QNt
 80gtK5kxqrkhTfjXL/3WTaAoG8LpLgWGYSBHnzHQ=
From: Zev Weiss <zev@bewilderbeest.net>
To: Guenter Roeck <linux@roeck-us.net>, Jean Delvare <jdelvare@suse.com>,
 linux-hwmon@vger.kernel.org
Subject: [PATCH v3 2/6] hwmon: (nct6775) Convert register access to regmap API
Date: Tue, 26 Apr 2022 00:18:44 -0700
Message-Id: <20220426071848.11619-3-zev@bewilderbeest.net>
...
---
 ...
 2 files changed, 663 insertions(+), 315 deletions(-)

diff --git a/drivers/hwmon/Kconfig b/drivers/hwmon/Kconfig
index c4e4adb6c302..da3546f20c0b 100644
--- a/drivers/hwmon/Kconfig
+++ b/drivers/hwmon/Kconfig
@@ -1467,6 +1467,7 @@ config SENSORS_NCT6775
 	depends on !PPC
...
index 2b91f7e05126..04e4d30c8540 100644
