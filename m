...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id CCF716DD0FF
	for <lists+openbmc@lfdr.de>; Tue, 11 Apr 2023 06:36:07 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4PwY1x5F6Kz3c8f
	for <lists+openbmc@lfdr.de>; Tue, 11 Apr 2023 14:36:05 +1000 (AEST)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20210112 header.b=R47kk79c;
	dkim-atps=neutral
X-Original-To: openbmc@lists.ozlabs.org
Delivered-To: openbmc@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized) smtp.mailfrom=gmail.com (client-ip=2607:f8b0:4864:20::1032; helo=mail-pj1-x1032.google.com; envelope-from=csf0711@gmail.com; receiver=<UNKNOWN>)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20210112 header.b=R47kk79c;
	dkim-atps=neutral
Received: from mail-pj1-x1032.google.com (mail-pj1-x1032.google.com [IPv6:2607:f8b0:4864:20::1032])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4PwV681fk0z3brQ;
	Tue, 11 Apr 2023 12:24:31 +1000 (AEST)
Received: by mail-pj1-x1032.google.com with SMTP id j8so4950916pjy.4;
        Mon, 10 Apr 2023 19:24:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112; t=1681179867; x=1683771867;
        h=thread-index:content-language:content-transfer-encoding
         :mime-version:message-id:date:subject:in-reply-to:references:to:from
         :from:to:cc:subject:date:message-id:reply-to;
        bh=V2PqVD/VBqVC9AcMC7cSqQl6i1dPmlal+fEY/NxkTBQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1681179867; x=1683771867;
        h=thread-index:content-language:content-transfer-encoding
         :mime-version:message-id:date:subject:in-reply-to:references:to:from
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=V2PqVD/VBqVC9AcMC7cSqQl6i1dPmlal+fEY/NxkTBQ=;
        b=
X-Gm-Message-State: AAQBX9d1Az2IjhY8FatYGutGgJ77wjdxjl59NK9nx3JZjBfXBqxrqPya
	UJVe2VG2ezL9jMJXpGEU7aE=
X-Google-Smtp-Source: AKy350bE/VfiruQLBC+9LEQ+f0ySrAHaFScB1XhaQZ9xyiVf8QGWp+z55e4Bqd7tdfdz31kcqTFrKw==
X-Received: by 2002:a05:6a20:c31e:b0:d9:e1b:652b with SMTP id dk30-20020a056a20c31e00b000d90e1b652bmr12327073pzb.59.1681179866974;
        Mon, 10 Apr 2023 19:24:26 -0700 (PDT)
Received: from RyanChenPC2 ([118.99.208.177])
        by smtp.gmail.com with ESMTPSA id w26-20020aa7859a000000b0063418ea5032sm4531693pfn.1.2023.04.10.19.24.24
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 10 Apr 2023 19:24:26 -0700 (PDT)
From: <csf0711@gmail.com>
...
References: <20230405022825.333246-1-ryan_chen@aspeedtech.com> <20230405022825.333246-3-ryan_chen@aspeedtech.com>
In-Reply-To: <20230405022825.333246-3-ryan_chen@aspeedtech.com>
Subject: RE: [PATCH v9 2/2] i2c: aspeed: support ast2600 i2c new register mode driver
Date: Tue, 11 Apr 2023 10:24:25 +0800
Message-ID: <17de01d96c1c$bd790790$386b16b0$@gmail.com>
MIME-Version: 1.0
...
Thread-Index: AQHZZ2ZXOd9ZM3I2BEub3OoW4qTApK8laH/A
...
Tested-by: Brian Chen <csf0711@gmail.com>
...
> +/*
> + * APB clk : 100Mhz
> + * div	: scl		: baseclk [APB/((div/2) + 1)] : tBuf [1/bclk
* 16]
> + * I2CG10[31:24] base clk4 for i2c auto recovery timeout counter (0xC6)
> + * I2CG10[23:16] base clk3 for Standard-mode (100Khz) min tBuf 4.7us
> + * 0x3c : 100.8Khz	: 3.225Mhz					  :
4.96us
> + * 0x3d : 99.2Khz	: 3.174Mhz					  :
5.04us
> + * 0x3e : 97.65Khz	: 3.125Mhz					  :
5.12us
> + * 0x40 : 97.75Khz	: 3.03Mhz					  :
5.28us
> + * 0x41 : 99.5Khz	: 2.98Mhz					  :
5.36us (default)
...
> +#define AST2600_I2CC_TTIMEOUT(x)			(((x) & GENMASK(4,
0)) <<
> 24)
> +#define AST2600_I2CC_TCKHIGHMIN(x)			(((x) & GENMASK(3,
0))
> << 20)
> +#define AST2600_I2CC_TCKHIGH(x)			(((x) & GENMASK(3,
0)) <<
> 16)
> +#define AST2600_I2CC_TCKLOW(x)			(((x) & GENMASK(3,
0)) <<
> 12)
> +#define AST2600_I2CC_THDDAT(x)			(((x) & GENMASK(1,
0)) <<
> 10)
> +#define AST2600_I2CC_TOUTBASECLK(x)			(((x) & GENMASK(1,
0))
> << 8)
> +#define AST2600_I2CC_TBASECLK(x)			((x) & GENMASK(3,
0))
> +
...
> GENMASK(5, 0))
> +#define AST2600_I2CC_SET_RX_BUF_LEN(x)		(((((x) - 1) &
GENMASK(4,
> 0)) << 16) | BIT(0))
> +#define AST2600_I2CC_SET_TX_BUF_LEN(x)		(((((x) - 1) &
GENMASK(4,
> 0)) << 8) | BIT(0))
...
> +#define AST2600_I2CS_SET_RX_DMA_LEN(x)	(((((x) - 1) & GENMASK(11,
0))
> << 16) | BIT(31))
> +#define AST2600_I2CS_RX_DMA_LEN_MASK	(GENMASK(11, 0) << 16)
> +
> +#define AST2600_I2CS_SET_TX_DMA_LEN(x)	((((x) - 1) & GENMASK(11,
0))
> | BIT(15))
...
> +
> +#define AST2600_I2C_GET_TX_DMA_LEN(x)		((x) & GENMASK(12,
0))
...
> &clk_div_reg);
> +	base_clk1 = (i2c_bus->apb_clk * 10) / ((((clk_div_reg & 0xff) + 2) *
10) /
> 2);
...
> +}
> +
> +static void ast2600_i2c_slave_byte_irq(struct ast2600_i2c_bus *i2c_bus,
u32
> sts)
> +{
...
> AST2600_I2CM_TX_CMD;
> +				writel(AST2600_I2CM_SET_TX_DMA_LEN(xfer_len
- 1),
> +				       i2c_bus->reg_base +
...
> +				xfer_len = 1;
> +				writel(msg->buf[0], i2c_bus->reg_base +
> AST2600_I2CC_STS_AND_BUFF);
> +			} else {
> +				xfer_len = 0;
> +			}
...
> i2c_bus->master_dma_addr, msg->len,
> +						 DMA_TO_DEVICE);
> +
i2c_put_dma_safe_msg_buf(i2c_bus->master_safe_buf,
> msg, true);
...
> +#ifdef CONFIG_I2C_SLAVE
> +		/* Workaround for master/slave package mode enable rx done
stuck
> issue
> +		 * When master go for first read (RX_DONE), slave mode will
also
> effect
...
> +
> +		if (msg->flags & I2C_M_RECV_LEN) {
> +			msg->len = msg->buf[0] + ((msg->flags &
I2C_CLIENT_PEC) ? 2 :
> 1);
> +			msg->len = min_t(unsigned int, msg->len,
> I2C_SMBUS_BLOCK_MAX);
...
MASTER_TRIGGER_LAST_STOP;
> +				}
> +				writel(AST2600_I2CM_SET_RX_DMA_LEN(xfer_len
- 1),
> +				       i2c_bus->reg_base +
AST2600_I2CM_DMA_LEN);
> +				writel(i2c_bus->master_dma_addr +
...
> +			/* Disable ALT INT */
> +			writel(ier & ~AST2600_I2CM_SMBUS_ALT,
i2c_bus->reg_base +
> AST2600_I2CM_IER);
...
> AST2600_I2CM_ISR);
> +			dev_err(i2c_bus->dev,
> +				"ast2600_master_alert_recv bus id %d,
Disable Alt, Please
> Imple\n",
> +				i2c_bus->adap.nr);
> +			return 1;
...
> +#ifdef CONFIG_I2C_SLAVE
> +	/* avoid race condication slave is wait and master wait 1st slave
operate
> */
> +	if (i2c_bus->mode == BUFF_MODE)
> +		writel(AST2600_I2CS_PKT_DONE, i2c_bus->reg_base +
