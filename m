...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id 6651A318664
	for <lists+openbmc@lfdr.de>; Thu, 11 Feb 2021 09:37:46 +0100 (CET)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 4Dbqkv20fDzDwmG
	for <lists+openbmc@lfdr.de>; Thu, 11 Feb 2021 19:37:43 +1100 (AEDT)
...
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized)
 ...
 envelope-from=3rowkyaykb7cdjlrpbdlldib.zljlmbkyjzifpqp.lwixyp.lod@flex--gmouse.bounces.google.com;
 receiver=<UNKNOWN>)
Authentication-Results: lists.ozlabs.org; dkim=pass (2048-bit key;
 unprotected) header.d=google.com header.i=@google.com header.a=rsa-sha256
 header.s=20161025 header.b=JXtQPR2g; dkim-atps=neutral
Received: from mail-wm1-x34a.google.com (mail-wm1-x34a.google.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4DbqhG343hzDwmZ
 for <openbmc@lists.ozlabs.org>; Thu, 11 Feb 2021 19:35:20 +1100 (AEDT)
Received: by mail-wm1-x34a.google.com with SMTP id p8so2829039wmq.7
 for <openbmc@lists.ozlabs.org>; Thu, 11 Feb 2021 00:35:20 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=20161025;
 h=sender:date:in-reply-to:message-id:mime-version:references:subject
 :from:to:cc; bh=gxBWQwdwvnT+f/kM4i7qiEP7cHqDJC6gxxYlsYZ4WuE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:sender:date:in-reply-to:message-id:mime-version
 :references:subject:from:to:cc;
 bh=gxBWQwdwvnT+f/kM4i7qiEP7cHqDJC6gxxYlsYZ4WuE=;
 b=
X-Gm-Message-State: AOAM531utRJARtsbN5+yi7CjCZ7jjexmT+ULRTb6VFd1XmnrUwKwUxDI
 AxJaM0js84IKtY0/jQzSvBFzh8hIzNDCGcdVdRC9y/5vPCUcr0Z1ne1rpEAub3FZENAFnnwxOTt
 EHVvwqLCecYLrpU7lDW3NouBRqhUhiIkM3e2WiGmJqHLMspdiSEYD4GDyZj7TcyrV
X-Google-Smtp-Source: ABdhPJx4CE+UN/E4OBlUnY6FAOJCaHIillezj7rTqpbVwGIunVYZdKNDWe+lf9e/gTEIBYyKw20TCGH7s5U=
X-Received: from gmouse.zrh.corp.google.com
 ([2a00:79e0:42:200:bc3a:4732:1655:1b61])
 (user=gmouse job=sendgmr) by 2002:a1c:6487:: with SMTP id
 y129mr4016903wmb.106.1613032516913; 
 Thu, 11 Feb 2021 00:35:16 -0800 (PST)
Date: Thu, 11 Feb 2021 09:34:54 +0100
In-Reply-To: <20210211083454.37117-1-gmouse@google.com>
Message-Id: <20210211083454.37117-2-gmouse@google.com>
Mime-Version: 1.0
References: <20210211083454.37117-1-gmouse@google.com>
X-Mailer: git-send-email 2.30.0.478.g8a0d178c01-goog
Subject: [PATCH] ARM: dts: nuvoton: Add Fii Kudo system
...
index 9a2ab5e6e924..5fd12e8909d3 100644
--- a/arch/arm/boot/dts/Makefile
+++ b/arch/arm/boot/dts/Makefile
@@ -338,6 +338,7 @@ dtb-$(CONFIG_ARCH_LPC32XX) += \
 	lpc3250-phy3250.dtb
...
index 000000000000..0b65505333bc
--- /dev/null
