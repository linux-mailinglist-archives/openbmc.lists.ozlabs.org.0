...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id DBC8778FEEB
	for <lists+openbmc@lfdr.de>; Fri,  1 Sep 2023 16:22:04 +0200 (CEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20221208 header.b=W0yAa6UA;
	dkim-atps=neutral
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4RcgG25vdPz3c3Y
	for <lists+openbmc@lfdr.de>; Sat,  2 Sep 2023 00:22:02 +1000 (AEST)
X-Original-To: openbmc@lists.ozlabs.org
Delivered-To: openbmc@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20221208 header.b=W0yAa6UA;
	dkim-atps=neutral
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized) smtp.mailfrom=gmail.com (client-ip=2607:f8b0:4864:20::62f; helo=mail-pl1-x62f.google.com; envelope-from=chandutmba@gmail.com; receiver=lists.ozlabs.org)
Received: from mail-pl1-x62f.google.com (mail-pl1-x62f.google.com [IPv6:2607:f8b0:4864:20::62f])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4RcgFN1ktlz3bT8
	for <openbmc@lists.ozlabs.org>; Sat,  2 Sep 2023 00:21:26 +1000 (AEST)
Received: by mail-pl1-x62f.google.com with SMTP id d9443c01a7336-1c1f7f7151fso14916225ad.1
        for <openbmc@lists.ozlabs.org>; Fri, 01 Sep 2023 07:21:26 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1693578080; x=1694182880; darn=lists.ozlabs.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=YAm6wHqlXkEPcdEVVItmY9vmWbALLk6EWOluovXahB4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1693578080; x=1694182880;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=YAm6wHqlXkEPcdEVVItmY9vmWbALLk6EWOluovXahB4=;
        b=
X-Gm-Message-State: AOJu0Yx5CJ72IIpQNsCC4Y0izGZdvAUcnvpjgjEKxqSn5Hg7JlU0YTRV
	tA+bVWR1dgzaATpt3nLxhSONEsr46nxMA1kYYdY=
X-Google-Smtp-Source: AGHT+IHqhgHAiTu2h0oJkMyFGLSwHtS2W0s+00uK7tzz1phwulFAj4In1FzkNsimVnU6nLDLsUBvijhDFom6zukLK70=
X-Received: by 2002:a17:90a:ea08:b0:26d:4642:1bd7 with SMTP id
 w8-20020a17090aea0800b0026d46421bd7mr2386759pjy.34.1693578079400; Fri, 01 Sep
 2023 07:21:19 -0700 (PDT)
MIME-Version: 1.0
References: <CAPY-kLVD7ONa6fkSrQ5sfAxK4UcGZSyHoMr6sb6oQPTafMT_fw@mail.gmail.com>
 ...
 <CAPY-kLUTFpsjD4=HxoYfE=fedJHeKKOLafp_7_BkJy0wEAFZEg@mail.gmail.com> <CAH2-KxDi4pvQ+Y6WJ6_LPRvjQgrxH=tKhe59ODGSeKgU=eVwrA@mail.gmail.com>
In-Reply-To: <CAH2-KxDi4pvQ+Y6WJ6_LPRvjQgrxH=tKhe59ODGSeKgU=eVwrA@mail.gmail.com>
From: chandu chanti <chandutmba@gmail.com>
Date: Fri, 1 Sep 2023 19:51:06 +0530
Message-ID: <CAPY-kLX2Vhyva_p6bKe7LGG-2fo0QB=AeeDnipcMAPz18+=Amg@mail.gmail.com>
Subject: Re: Error handling
To: Ed Tanous <edtanous@google.com>
Content-Type: multipart/related; boundary="000000000000d298c306044cdfc6"
...
--000000000000d298c306044cdfc6
Content-Type: multipart/alternative; boundary="000000000000d298c106044cdfc5"

--000000000000d298c106044cdfc5
...
On Thu, Aug 31, 2023 at 10:31=E2=80=AFPM Ed Tanous <edtanous@google.com> wr=
ote:

>
>
> On Thu, Aug 31, 2023 at 4:47=E2=80=AFAM chandu chanti <chandutmba@gmail.c=
om>
> wrote:
>
>> Hi team,
...
>>
>
> While this is true for properties that are intended to be sent directly t=
o
...
>> data type called mydatatype_t. An object of this class will be created w=
ith
>> the D-Bus property value as input. This object will be assigned to the J=
SON
...
>> value matches the error value, we will update the property value as null=
 in
>> the Redfish JSON response; otherwise, the corresponding value on D-Bus w=
ill
>> be used.
>>
>
...
>> null value will be allocated to the JSON response. Example for the uint1=
6_t
>> data type.
>>
>
...
>
>>
>> On Fri, Aug 4, 2023 at 12:37=E2=80=AFPM Shakeeb Pasha <shakeebbk@gmail.c=
om>
>> wrote:
>>
...
>>> error. But this did not work well with current bmcweb implementation(ge=
t
...
>>> extreme cases like if the property is u32, and if the default value use=
d
...
>>>> bmc
>>>> > web. We are considering the following approaches to implement it, bu=
t
...
>>>> > Hi Team,
>>>> >
>>>> > We are planning to handle errors from backend services in bmc web. W=
e
...
>>>>
>>>> I didn't see anyone else answer this.  Is your question about how to
>>>> architect or design your D-Bus interfaces?  Is the reference the BMCWe=
b
>>>> merely to provide context as a consumer of these D-Bus services?  I
>>>> assume so.
>>>>
...
>>>> > there a reference implementation available for setting default value=
s
...
<div dir=3D"ltr"><br>&gt;Overall, I&#39;ve read the code, and your email, a=
nd I really have no idea what&#39;s being proposed that doesn&#39;t already=
 exist in a much simpler form, <br>&gt;using the existing error handling me=
chanisms.=C2=A0 While your point that one failing property can fail the who=
le call is correct, <br>&gt;that&#39;s the intent.=C2=A0 If an internal ser=
vice fails, that needs propagated to the user, in the form of an error code=
, per the Redfish specification.<br><br>please refer Table 17 =E2=80=94 Pri=
mitive data types in <a href=3D"https://www.dmtf.org/sites/default/files/st=
andards/documents/DSP0266_1.18.0.pdf">https://www.dmtf.org/sites/default/fi=
les/standards/documents/DSP0266_1.18.0.pdf</a><br>null value, which the ser=
vice uses when it is unable to determine the property&#39;s value due to an=
 error or<br>other temporary condition, or if the schema has requirements f=
or using null for other special conditions.<br><br><br>&gt; One thing I don=
&#39;t understand is what code is actually failing in this case?=C2=A0 Can =
you point to a place where an error is returned that you&#39;d like &gt;han=
dled differently? =C2=A0<br>&gt; Speaking in concrete terms would help to m=
ake the generalized change you&#39;re attempting here<br><br>If there is an=
 error in only one property, we want to represent that a specific property =
is failing in the URI instead of failing the entire URI.<br><br><br>&gt;Ple=
ase look at error_messages.hpp and error_messages.cpp<br><br>We cannot have=
 error messages when the HTTP return code is 200.<br><br><br>&gt; For prope=
rties that have a &quot;null&quot; or &quot;invalid&quot; value, this is al=
ready implemented, generally with a simple branch.<br>&gt; Example from sen=
sors:<br>&gt;<a href=3D"https://github.com/openbmc/bmcweb/blob/99bf026224d6=
ea60be27bd36793ddfaea5537d2a/redfish-core/lib/sensors.hpp#L934">https://git=
hub.com/openbmc/bmcweb/blob/99bf026224d6ea60be27bd36793ddfaea5537d2a/redfis=
h-core/lib/sensors.hpp#L934</a><br><br>This addresses only the double datat=
ype. We are planning to implement it for all data types. Please refer to th=
...
email.<br><br>&gt;&gt; 1 . Using exceptions in our backend D-Bus service by=
 throwing exceptions in the D-Bus property get handlers. <br>&gt;&gt;It wor=
ks fine for the Get property method call. However, when using the Get All m=
ethod call, <br>&gt;&gt;if one property fails, an error is returned without=
 checking the other properties. <br>&gt;&gt;Is there a way to implement exc=
eptions in GetAll so that even if one property fails, we can still fetch th=
e remaining properties.<br><br><br>Error represenation Table for different =
data types<br>| D-Bus Data Type | Value of the D-Bus Property in case of Er=
ror | Property Value as seen on Redfish |<br>|-----------------|-----------=
----------------------------------|----------------------------------|<br>|=
 INT16 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 | INT_MAX =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 | null =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 |<br>| UINT1=
6 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0| UINT_MAX =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
...
mailto:edtanous@google.com">edtanous@google.com</a>&gt; wrote:<br></div><bl=
...
ail_attr">On Thu, Aug 31, 2023 at 4:47=E2=80=AFAM chandu chanti &lt;<a href=
=3D"mailto:chandutmba@gmail.com" target=3D"_blank">chandutmba@gmail.com</a>=
&gt; wrote:<br></div><blockquote class=3D"gmail_quote" style=3D"margin:0px =
0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div=
 dir=3D"ltr">Hi team,<br><br>We have drafted a proposal for=C2=A0 &quot;<sp=
an style=3D"font-family:Calibri,sans-serif;font-size:14.6667px">Using defau=
lt values in D-Bus properties to indicate errors&quot;=C2=A0</span>=C2=A0as=
=C2=A0<span dir=3D"ltr">communicated in previous mail.</span><br><br>Issue =
with Existing Implementation:<br>Error handling is not implemented in the e=
xisting bmcweb source.</div></blockquote><div><br></div><div>This statement=
 is verifiably incorrect.=C2=A0 Many discussions have been had about how we=
 handle Dbus, json, and Redfish errors, and the handling policies are writt=
en down in DBUS_USAGE.md.=C2=A0 =C2=A0Please familiarize yourself with thos=
e previous discussions, and if you believe=C2=A0the conclusion was incorrec=
t, quote those in your response.</div><div>=C2=A0</div><blockquote class=3D=
"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(2=
04,204,204);padding-left:1ex"><div dir=3D"ltr"> The values fetched from D-B=
us are used directly in the Redfish response, except for some properties.</=
div></blockquote><div><br></div><div>While this is true for properties that=
 are intended to be sent directly to the user, like Asset information, it&#=
39;s not true of all properties.</div><div>=C2=A0</div><blockquote class=3D=
"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(2=
04,204,204);padding-left:1ex"><div dir=3D"ltr"> T<span dir=3D"ltr">here was=
 no way to represent error for a given data type on Redfish.</span></div></=
blockquote><div><br></div><div>Please look at error_messages.hpp and error_=
messages.cpp</div><div>=C2=A0</div><blockquote class=3D"gmail_quote" style=
=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding=
-left:1ex"><div dir=3D"ltr"><br><br>New Implementation Proposal:<br>We plan=
 to handle errors from backend D-Bus services in bmcweb using a custom data=
 type class. We will implement a helper class to create a new data type cal=
led mydatatype_t. An object of this class will be created with the D-Bus pr=
operty value as input. This object will be assigned to the JSON response us=
ing the assignment operator. This assignment operation will invoke the to_j=
son function with the mydatatype_t object, where D-Bus values will be valid=
ated based on their data types.=C2=A0</div></blockquote><blockquote class=
=3D"gmail_quote" style=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rg=
b(204,204,204);padding-left:1ex"><div dir=3D"ltr"><br>Data Types and Defaul=
t Values:<br>The following values will be set on the D-Bus property in case=
 of an error, based on the data type.</div></blockquote><div><br></div><div=
>If the dbus data type is incorrect this already sets internal error (500).=
=C2=A0 Please look at=C2=A0sdbusplus::unpackPropertiesNoThrow usage in bmcw=
eb.=C2=A0 Given that the interface failed, this is the most specific error =
we can give the user.=C2=A0 We do log the source of the error though.</div>=
<div>=C2=A0</div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0px =
0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div dir=
=3D"ltr"> In Redfish, we will validate these properties. If the D-Bus prope=
rty value matches the error value, we will update the property value as nul=
l in the Redfish JSON response; otherwise, the corresponding value on D-Bus=
 will be used.<br></div></blockquote><div><br></div><div>For properties tha=
t have a &quot;null&quot; or &quot;invalid&quot; value, this is already imp=
lemented, generally with a simple branch.</div><div>Example from sensors:<b=
r><a href=3D"https://github.com/openbmc/bmcweb/blob/99bf026224d6ea60be27bd3=
6793ddfaea5537d2a/redfish-core/lib/sensors.hpp#L934" target=3D"_blank">http=
s://github.com/openbmc/bmcweb/blob/99bf026224d6ea60be27bd36793ddfaea5537d2a=
/redfish-core/lib/sensors.hpp#L934</a><br></div><div><br></div><div><br></d=
iv><div>=C2=A0</div><blockquote class=3D"gmail_quote" style=3D"margin:0px 0=
px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex"><div =
dir=3D"ltr"><br><table border=3D"0" cellspacing=3D"0" cellpadding=3D"0" sty=
